import { bt as writable, F as onMount, I as state, o as get$1, z as set$1, G as tick, bw as settled } from "./BpheISZ8.js";
class HttpError {
  /**
   * @param {number} status
...
const base = globalThis.__sveltekit_wdez5k?.base ?? "";
const assets = globalThis.__sveltekit_wdez5k?.assets ?? base ?? "";
const version = "1788101213795";
...
async function start(_app, _target, hydrate) {
  if (globalThis.__sveltekit_wdez5k?.data) {
    globalThis.__sveltekit_wdez5k.data;
  }
...
//# sourceMappingURL=BFu_ue3Y.js.map
