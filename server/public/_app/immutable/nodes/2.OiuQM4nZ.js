...
function Settings($$anchor, $$props) {
  ...
  let stickerpackUploadName = null;
  async function createStickerPack() {
    const pack = await addStickerpack(stickerpackUploadName, get(stickerpackUploadingIcon));
    if (!pack) return;
    if (core2.stickersCache) {
      core2.stickersCache.push(pack);
    }
  }
  let currentPackName = state(void 0);
...
//# sourceMappingURL=2.OiuQM4nZ.js.map
