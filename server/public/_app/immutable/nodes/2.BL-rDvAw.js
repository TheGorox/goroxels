...
var root_1$g = from_html(`<button><div class="btn-content svelte-g9c1iq"><!> <!></div></button>`);
...
var root_1$f = from_html(`<div class="header svelte-d13yz0"><!></div>`);
...
var root_1$e = from_html(`<div role="button" tabindex="0"> </div>`);
...
var root_1$d = from_html(`<table class="vtlist-inner"><!><tbody><!></tbody></table> <!>`, 1);
...
var root_1$c = from_html(`<div class="childrenContainer svelte-1qidjt8"><!></div>`);
...
var root_1$a = from_html(`<div class="body svelte-1w8c893"><a href="/api/auth/vk" class="svelte-1w8c893"><!></a> <a href="/api/auth/discord" class="svelte-1w8c893"><!></a> <a href="/api/auth/google" class="svelte-1w8c893"><!></a></div>`);
...
function animateEmoji(emojiContainer, timeSeconds = 1) {
  const floatingBlock = document.createElement("div");
  floatingBlock.style = "position: fixed; z-index: 999999999";
...
function Settings($$anchor, $$props) {
  ...
  let stickerpackUploadedIcon = state(null);
  {
                    ...
                    var node_1 = sibling(child(div_2));
                    {
                      const left = ($$anchor5) => {
                        UploadHandler($$anchor5, {
                          onFileSelect: (file) => set$1(stickerpackUploadedIcon, file, true),
                          onClear: () => set$1(stickerpackUploadedIcon, null)
                        });
                      };
                      const right = ($$anchor5) => {
...
//# sourceMappingURL=2.BL-rDvAw.js.map
