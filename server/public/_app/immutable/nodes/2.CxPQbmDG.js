...
var root_30 = from_html(`<div><img class="svelte-191yngm"/></div>`);
...
function Chat($$anchor, $$props) {
  ...
  let activeStickerpack = "General";
  let activeStickers = user_derived(() => core2?.stickersCache?.find((p) => p.title === activeStickerpack)?.stickers || []);
  ...
  var node_13 = sibling(node_12, 2);
  {
    var consequent_5 = ($$anchor2) => {
      Popover($$anchor2, {
        ...
        closeDelay: 9999999,
        panelStyle: "width: 246px; height: 270px; user-select: none;",
        children: ($$anchor3, $$slotProps) => {
          {
            ...
            const stickers = ($$anchor4) => {
              ...
              each(div_29, 21, () => core2.stickersCache, (stickerpack) => stickerpack.id, ($$anchor5, stickerpack) => {
                ...
                reset(div_30);
                template_effect(() => {
                  set_class(div_30, 1, `stickerpackContainer ${activeStickerpack === get(stickerpack).title ? "active" : ""}`, "svelte-191yngm");
                  set_attribute(img, "src", get(stickerpack).thumbUrl || generalStickerpackIcon);
...
//# sourceMappingURL=2.CxPQbmDG.js.map
