...
var root$8 = from_html(`<div class="uploadContainer svelte-1hretyp"><div class="iconContainer svelte-1hretyp"></div> <span class="svelte-1hretyp"> </span></div>`);
...
var root_8 = from_html(`<div class="createStickerpackPanel">Create sticker pack <!> <!> <!></div> <div class="stickersPanel"></div>`, 1);
            ...
            const admin = ($$anchor3) => {
              {
                ...
                CollapsibleBlock($$anchor3, {
                  ...
                  children: ($$anchor4, $$slotProps2) => {
                    ...
                    UploadHandler(node_1, {});
                    var node_2 = sibling(node_1, 2);
                    {
                      const left = ($$anchor5) => {
                        next();
                        var text_1 = text();
                        template_effect(($04) => set_text(text_1, $04), [() => $_()("sticker_pack_name")]);
                        append($$anchor5, text_1);
                      };
                      const right = ($$anchor5) => {
                        Input($$anchor5, { type: "text" });
                      };
                      Row(node_2, { left, right, $$slots: { left: true, right: true } });
                    }
                    var node_3 = sibling(node_2, 2);
                    {
                      const right = ($$anchor5) => {
                        Button($$anchor5, {
                          children: ($$anchor6, $$slotProps3) => {
                            next();
                            var text_2 = text("Create sticker pack");
                            append($$anchor6, text_2);
                          },
                          $$slots: { default: true }
                        });
                      };
                      Row(node_3, { alignRight: "right", right, $$slots: { right: true } });
                    }
                    reset(div_2);
                    next(2);
                    append($$anchor4, fragment_6);
...
//# sourceMappingURL=2.CbZ7ov7s.js.map
