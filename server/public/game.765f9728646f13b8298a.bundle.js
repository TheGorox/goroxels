...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "/img/brimstone.png");
...
/***/ "./src/img/movie/BrightnessHigh.svg"
/*!******************************************!*\
  !*** ./src/img/movie/BrightnessHigh.svg ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "/img/BrightnessHigh.svg");

/***/ },

/***/ "./src/img/movie/BrightnessHighFill.svg"
/*!**********************************************!*\
  !*** ./src/img/movie/BrightnessHighFill.svg ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "/img/BrightnessHighFill.svg");

/***/ },

/***/ "./src/img/movie/SoundOff.svg"
/*!************************************!*\
  !*** ./src/img/movie/SoundOff.svg ***!
  \************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "/img/SoundOff.svg");

/***/ },

/***/ "./src/img/movie/SoundOn.svg"
/*!***********************************!*\
  !*** ./src/img/movie/SoundOn.svg ***!
  \***********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "/img/SoundOn.svg");
...
class ChunkManager {
    ...
    dumpZone(startX, startY, w, h) {
        ...
        const startChunkX = Math.floor(startX / _config__WEBPACK_IMPORTED_MODULE_2__.chunkSize),
            startChunkY = Math.floor(startY / _config__WEBPACK_IMPORTED_MODULE_2__.chunkSize),
            endChunkX = Math.floor((startX + w) / _config__WEBPACK_IMPORTED_MODULE_2__.chunkSize),
            endChunkY = Math.floor((startY + h) / _config__WEBPACK_IMPORTED_MODULE_2__.chunkSize);
        ...
        for (let cx = startChunkX; cx <= endChunkX; cx++) {
            for (let cy = startChunkY; cy <= endChunkY; cy++) {
                ...
                const offX = (chunk.x * _config__WEBPACK_IMPORTED_MODULE_2__.chunkSize) - startX,
                    offY = (chunk.y * _config__WEBPACK_IMPORTED_MODULE_2__.chunkSize) - startY;
...
class Renderer {
    ...
    preRenderBrush() {
        ...
        if(size === 2){
            ...
            circle = _utils_shapes__WEBPACK_IMPORTED_MODULE_8__["default"].filledCircle(0, 0, r+1);
        }
        let circleMatrix = [];
    ...
    checkAndroidGc() {
        if (!_globals__WEBPACK_IMPORTED_MODULE_3__["default"].mobile) return;
        ...
        if (bad) {
            ...
            _globals__WEBPACK_IMPORTED_MODULE_3__["default"].chunkManager.reRenderAll();
        }
    }
...
/* harmony import */ var _workers__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../workers */ "./src/workers/index.js");
        ...
        switch (dv.getUint8(0)) {
            ...
            case _protocol__WEBPACK_IMPORTED_MODULE_2__.OPCODES.pixels: {
                ...
                for (let i = 6; i < dv.byteLength; i += 5) {
                    ...
                    if (col > _config__WEBPACK_IMPORTED_MODULE_3__.allColors.length) continue;
            ...
            case _protocol__WEBPACK_IMPORTED_MODULE_2__.OPCODES.placeBatch: {
                ...
                for (let off = 1; off < dv.byteLength; off += PIXEL_LENGTH) {
                    ...
                    if (c > _config__WEBPACK_IMPORTED_MODULE_3__.allColors.length) continue;
            ...
            case _protocol__WEBPACK_IMPORTED_MODULE_2__.OPCODES.pastePixels: {
                const startX = dv.getInt16(1);
                const startY = dv.getInt16(3);
                const width = dv.getInt16(5);

                const u8a = new Uint8Array(dv.buffer, 7);
                _workers__WEBPACK_IMPORTED_MODULE_12__["default"].compressWorker.decompress(u8a).then(decompressed => {
...
/* harmony import */ var _tools__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tools */ "./src/js/tools/index.js");
    ...
    initEvents() {
        ...
        if (isMobile) {
            ...
            em.on('wheel', e => {
                ...
                _camera__WEBPACK_IMPORTED_MODULE_3__["default"].moveBy((dx / oldZoom), (dy / oldZoom));
                _camera__WEBPACK_IMPORTED_MODULE_3__["default"].moveBy(-(dx / _camera__WEBPACK_IMPORTED_MODULE_3__["default"].zoom), -(dy / _camera__WEBPACK_IMPORTED_MODULE_3__["default"].zoom));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   curHistoryCanvasUrl: () => (/* binding */ curHistoryCanvasUrl),
...
/* harmony import */ var _ui_palette__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ui/palette */ "./src/js/ui/palette.js");
/* harmony import */ var _ui_toggles__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ui/toggles */ "./src/js/ui/toggles.js");
/* harmony import */ var _utils_localStorage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/localStorage */ "./src/js/utils/localStorage.js");
/* harmony import */ var _winamp_player__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./winamp/player */ "./src/js/winamp/player.js");
/* harmony import */ var _windows__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./windows */ "./src/js/windows.js");
/* harmony import */ var _fxcanvas__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./fxcanvas */ "./src/js/fxcanvas.js");
/* harmony import */ var _img_movie_SoundOn_svg__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../img/movie/SoundOn.svg */ "./src/img/movie/SoundOn.svg");
/* harmony import */ var _img_movie_SoundOff_svg__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../img/movie/SoundOff.svg */ "./src/img/movie/SoundOff.svg");
/* harmony import */ var _img_movie_BrightnessHigh_svg__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../img/movie/BrightnessHigh.svg */ "./src/img/movie/BrightnessHigh.svg");
/* harmony import */ var _img_movie_BrightnessHighFill_svg__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../img/movie/BrightnessHighFill.svg */ "./src/img/movie/BrightnessHighFill.svg");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./utils/conversions */ "./src/js/utils/conversions.js");
/* harmony import */ var _utils_math__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./utils/math */ "./src/js/utils/math.js");
/* harmony import */ var _shared_config__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../shared/config */ "../shared/config.js");
/* harmony import */ var _shared_config__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(_shared_config__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./config */ "./src/js/config.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
function initInputs() {
    ...
    (0,_windows__WEBPACK_IMPORTED_MODULE_10__.initButtons)();
...
function initOtherCoolFeatures() {
    ...
    // initModMenu();
    (0,_ui_toggles__WEBPACK_IMPORTED_MODULE_7__.initMobileMenuToggler)();
    (0,_ui_palette__WEBPACK_IMPORTED_MODULE_6__.initPalette)();
    (0,_ui_config__WEBPACK_IMPORTED_MODULE_5__.initUISettings)();
    (0,_Chat__WEBPACK_IMPORTED_MODULE_0__.initMobileChatToggle)();
    (0,_windows__WEBPACK_IMPORTED_MODULE_10__.initHelpButton)();
    _player__WEBPACK_IMPORTED_MODULE_3__["default"].init();
    (0,_ui_config__WEBPACK_IMPORTED_MODULE_5__.initCoordsClick)();
    (0,_windows__WEBPACK_IMPORTED_MODULE_10__.initOnlineViewer)();
    (0,_ui_config__WEBPACK_IMPORTED_MODULE_5__.initMenuResizer)();
    // show tooltip animation instead
    // showHelpIfFirstTime();
    (0,_winamp_player__WEBPACK_IMPORTED_MODULE_9__.startWinampRadio)();
...
function initHelpHint() {
    if ((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_8__.getLS)('helpHintShown', false) === '1') {
        return;
    }
    (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_8__.setLS)('helpHintShown', '1', false);
...
function initMovieShit() {
    if (_config__WEBPACK_IMPORTED_MODULE_19__.canvasId !== (_shared_config__WEBPACK_IMPORTED_MODULE_18___default().telek).canvas) return;
    ...
    function createSvgToggleButton({
        ...
        function draw(ctx) {
            ...
            if (!svg) return _fxcanvas__WEBPACK_IMPORTED_MODULE_11__.FX_STATE.FINISHED;

            const rect = getIconBoardBounds(bounds);

            let fxState = _fxcanvas__WEBPACK_IMPORTED_MODULE_11__.FX_STATE.FINISHED;

            if (isEnabledRef()) {
                const passed = Date.now() - enabledAt;
                if (passed < 1000) fxState = _fxcanvas__WEBPACK_IMPORTED_MODULE_11__.FX_STATE.IN_PROCESS;

                ctx.globalAlpha =
                    passed < 1000
                        ? (0,_utils_math__WEBPACK_IMPORTED_MODULE_17__.mapRange)(1000 - passed, 0, 1000, 0.3, 1)
                        : 0.3;
            } else {
                ctx.globalAlpha = 1;
            }
    ...
    const origOnStringMessage = _globals__WEBPACK_IMPORTED_MODULE_2__["default"].socket.onStringMessage;

    _globals__WEBPACK_IMPORTED_MODULE_2__["default"].socket.onStringMessage = (msg) => {
        origOnStringMessage.call(_globals__WEBPACK_IMPORTED_MODULE_2__["default"].socket, msg);
    ...
    const telekX = (_shared_config__WEBPACK_IMPORTED_MODULE_18___default().telek).x;
    const telekY = (_shared_config__WEBPACK_IMPORTED_MODULE_18___default().telek).y;
    const telekSize = (_shared_config__WEBPACK_IMPORTED_MODULE_18___default().telek).size;
    ...
    const soundButton = createSvgToggleButton({
        ...
        svgOnUrl: _img_movie_SoundOn_svg__WEBPACK_IMPORTED_MODULE_12__["default"],
        svgOffUrl: _img_movie_SoundOff_svg__WEBPACK_IMPORTED_MODULE_13__["default"],
    ...
    const dimButton = createSvgToggleButton({
        ...
        svgOnUrl: _img_movie_BrightnessHigh_svg__WEBPACK_IMPORTED_MODULE_14__["default"],
        svgOffUrl: _img_movie_BrightnessHighFill_svg__WEBPACK_IMPORTED_MODULE_15__["default"],
        isEnabledRef: () => dimEnabled,
        onToggle: toggleDim
    });

    function getIconBoardBounds(icon) {
        const [x, y] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_16__.boardToScreenSpace)(icon.x, icon.y);
        return {
            x, y,
            width: icon.width,
            height: icon.height
    ...
    function getTelekBoardBounds() {
        const [x1, y1] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_16__.boardToScreenSpace)(telekX, telekY, false);
        const [x2, y2] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_16__.boardToScreenSpace)(telekX + telekSize, telekY + telekSize, false);
    ...
    _globals__WEBPACK_IMPORTED_MODULE_2__["default"].fxRenderer.add(new _fxcanvas__WEBPACK_IMPORTED_MODULE_11__.FX(ctx => {
        let state = _fxcanvas__WEBPACK_IMPORTED_MODULE_11__.FX_STATE.FINISHED;
        ...
        if (dimEnabled) {
            ...
            ctx.fillStyle = 'black';
            ctx.globalAlpha = (0,_utils_math__WEBPACK_IMPORTED_MODULE_17__.mapRange)(curOpacity, 0, 1, 0, 0.8);
    ...
    document.addEventListener('pointerdown', e => {
        ...
        if (soundButton.hitTest(cx, cy) || dimButton.hitTest(cx, cy)) {
            _player__WEBPACK_IMPORTED_MODULE_3__["default"].suspendColors();
        }
    });

    document.addEventListener('pointerup', () => {
        setTimeout(() => _player__WEBPACK_IMPORTED_MODULE_3__["default"].restoreColors());
    });
...
function placePixels(pixels, store = true, isCtrlZ = false) {
    ...
    _globals__WEBPACK_IMPORTED_MODULE_3__["default"].socket.sendPixels(outPixels, false);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   decBrush: () => (/* binding */ decBrush),
/* harmony export */   incBrush: () => (/* binding */ incBrush)
/* harmony export */ });
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");




const incBrush = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('+brush size', 'BracketRight'); // [
incBrush.on('down', () => {
    if (_player__WEBPACK_IMPORTED_MODULE_0__["default"].brushSize >= 100) return;
    // 1,2,3,5,7,9,...
    const delta = _player__WEBPACK_IMPORTED_MODULE_0__["default"].brushSize >= 3 ? 2 : 1;
    (0,_player__WEBPACK_IMPORTED_MODULE_0__.updateBrush)(_player__WEBPACK_IMPORTED_MODULE_0__["default"].brushSize + delta);
});
const decBrush = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('-brush size', 'BracketLeft'); // ]
decBrush.on('down', () => {
    if(_player__WEBPACK_IMPORTED_MODULE_0__["default"].brushSize === 1) return;

    const delta = _player__WEBPACK_IMPORTED_MODULE_0__["default"].brushSize <= 4 ? 1 : 2;
    (0,_player__WEBPACK_IMPORTED_MODULE_0__.updateBrush)(_player__WEBPACK_IMPORTED_MODULE_0__["default"].brushSize - delta);
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _toolUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolUtils */ "./src/js/tools/toolUtils.js");
/* harmony import */ var _img_toolIcons_clicker_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../img/toolIcons/clicker.png */ "./src/img/toolIcons/clicker.png");
...
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
/* harmony import */ var _utils_shapes__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/shapes */ "./src/js/utils/shapes.js");
...
class Clicker extends _Tool__WEBPACK_IMPORTED_MODULE_9__["default"] {
    constructor(...args) {
        super(...args);
        ...
        (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.onToolManager)(() => {
            // mobile is already subscribed to pointer events
            // so this will duplicate them
            if (!_toolUtils__WEBPACK_IMPORTED_MODULE_0__.mobile) {
                _globals__WEBPACK_IMPORTED_MODULE_6__["default"].eventManager.on('mousedown', this.mousedown.bind(this));
                _globals__WEBPACK_IMPORTED_MODULE_6__["default"].toolManager.on('move', this.move.bind(this));
                _globals__WEBPACK_IMPORTED_MODULE_6__["default"].eventManager.on('mouseup', this.mouseup.bind(this));
            }
        });

        this.clrInterval = setInterval(() => {
            if (this.clearPending())
                (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.renderFX)();
        }, 250);

        // pending pixels debug visualizer
        this.fx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_5__.FX(this.render.bind(this));
        // addFX(this.fx);
    }
    ...
    mouseup(e) {
        if (_globals__WEBPACK_IMPORTED_MODULE_6__["default"].toolManager.tools['mover'].key !== 'LMB' || _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom <= 1) return;
        ...
        const [x, y] = [_player__WEBPACK_IMPORTED_MODULE_8__["default"].x, _player__WEBPACK_IMPORTED_MODULE_8__["default"].y];
        const color = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(x, y);
        if (this.checkPixel(x, y) && ~color)
            (0,_player__WEBPACK_IMPORTED_MODULE_8__.placePixel)(_player__WEBPACK_IMPORTED_MODULE_8__["default"].x, _player__WEBPACK_IMPORTED_MODULE_8__["default"].y, (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(x, y));
    }
    // end of mouse zone
    down(e) {
        if (this.mouseIsDown || _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom < this.minZoom) return;

        this.lastPos = [_player__WEBPACK_IMPORTED_MODULE_8__["default"].x, _player__WEBPACK_IMPORTED_MODULE_8__["default"].y];
        this.screenPos = [e.clientX, e.clientY];
    ...
    checkPixel(x, y) {
        const key = `${x},${y}`;
        const myColor = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(x, y);

        const pixel = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getPixel)(x, y), isProtected = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getProtect)(x, y);
        if (pixel === myColor || pixel === -1 || (isProtected && _me__WEBPACK_IMPORTED_MODULE_7__["default"].role < _constants__WEBPACK_IMPORTED_MODULE_4__.ROLE.TRUSTED)) return;
    ...
    */
    move(e, isUp = false) {
        ...
        if (!this.mouseIsDown ||
            e.gesture ||
            (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getCurCol)() === -1) return;

        // mobile and same pointerid as at down but also not initiated by 'up' event
        if (_toolUtils__WEBPACK_IMPORTED_MODULE_0__.mobile && this.pointerId !== e.pointerId)
            return;
        ...
        const mover = _globals__WEBPACK_IMPORTED_MODULE_6__["default"].toolManager.tools.mover;
        let x, y;
        if (mover.antijitterDownPos) {
            [x, y] = mover.antijitterDownPos;
        } else if (e.clientX && e.clientY) {
            [x, y] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_10__.screenToBoardSpace)(e.clientX, e.clientY);
        } else {
            [x, y] = [_player__WEBPACK_IMPORTED_MODULE_8__["default"].x, _player__WEBPACK_IMPORTED_MODULE_8__["default"].y];
        }
        
        
        let line = _utils_shapes__WEBPACK_IMPORTED_MODULE_11__["default"].line(x, y, this.lastPos[0], this.lastPos[1]);
        this.lastPos = [x, y];
        
        let circle = [[0, 0]];
        if (_player__WEBPACK_IMPORTED_MODULE_8__["default"].brushSize !== 1) {
            circle = _globals__WEBPACK_IMPORTED_MODULE_6__["default"].renderer.preRendered.brush.circle;
        }
        ...
        for (let [x, y] of line) {
            ...
            circle.forEach(([cx, cy]) => {
                ...
                if (this.checkPixel(_x, _y)) {
                    const myColor = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(_x, _y); // duplicate
    ...
    checkAllowance(count) {
        return _player__WEBPACK_IMPORTED_MODULE_8__["default"].bucket.allowance >= count;
    }

    place(pixels) {
        if (pixels.length === 0) return;

        _player__WEBPACK_IMPORTED_MODULE_8__["default"].bucket.spend(pixels.length);

        if (pixels.length == 1) {
            (0,_player__WEBPACK_IMPORTED_MODULE_8__.placePixel)(...pixels[0]);
        }
        else
            (0,_player__WEBPACK_IMPORTED_MODULE_8__.placePixels)(pixels);
    }

    render(ctx) {
        const zoom = _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom;
        ...
        for (let key of Object.keys(this._pendingPixels)) {
            ...
            ctx.fillStyle = _config__WEBPACK_IMPORTED_MODULE_3__.hexPalette[color];

            const [scrX, scrY] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_10__.boardToScreenSpace)(x, y);
...
const clicker = new Clicker('clicker', 'Space', _img_toolIcons_clicker_png__WEBPACK_IMPORTED_MODULE_1__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (clicker);

/***/ },

/***/ "./src/js/tools/colorSwap.js"
/*!***********************************!*\
  !*** ./src/js/tools/colorSwap.js ***!
  \***********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   colorSwap: () => (/* binding */ colorSwap),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
...
const colorSwap = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('swap colors', 'KeyX');
colorSwap.on('up', _player__WEBPACK_IMPORTED_MODULE_0__["default"].swapColors.bind(_player__WEBPACK_IMPORTED_MODULE_0__["default"]));

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (colorSwap);

/***/ },

/***/ "./src/js/tools/copy.js"
/*!******************************!*\
  !*** ./src/js/tools/copy.js ***!
  \******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _fxcanvas__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../fxcanvas */ "./src/js/fxcanvas.js");
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../globals */ "./src/js/globals.js");
/* harmony import */ var _paste__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./paste */ "./src/js/tools/paste.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _ui_elements__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../ui/elements */ "./src/js/ui/elements.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
/* harmony import */ var _utils_misc__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/misc */ "./src/js/utils/misc.js");
...
class Copy extends _Tool__WEBPACK_IMPORTED_MODULE_7__["default"] {
    constructor(...args) {
        super(...args);
    ...
    down(e) {
        if (this.state > 0 || _paste__WEBPACK_IMPORTED_MODULE_5__.paste.state > 0)
            return;
        ...
        _camera__WEBPACK_IMPORTED_MODULE_0__["default"].disableMove();
        _player__WEBPACK_IMPORTED_MODULE_6__["default"].suspendColors();
        _ui_elements__WEBPACK_IMPORTED_MODULE_8__.mainCanvas.css('cursor', 'crosshair');
        ...
        function mousedown() {
            if (altPressed) {
                lassoMode = true;
                lassoPoints = [[_player__WEBPACK_IMPORTED_MODULE_6__["default"].x, _player__WEBPACK_IMPORTED_MODULE_6__["default"].y]];
            } else {
                startX = _player__WEBPACK_IMPORTED_MODULE_6__["default"].x;
                startY = _player__WEBPACK_IMPORTED_MODULE_6__["default"].y;
            }
        }
        function mousemove() {
            if (lassoMode) {
                let x = _player__WEBPACK_IMPORTED_MODULE_6__["default"].x, y = _player__WEBPACK_IMPORTED_MODULE_6__["default"].y;

                lassoPoints.push([x, y]);
            } else {
                endX = _player__WEBPACK_IMPORTED_MODULE_6__["default"].x + 1;
                endY = _player__WEBPACK_IMPORTED_MODULE_6__["default"].y + 1;
            }
        }
        function mouseup() {
            // area is selected and we can tell Paste tool to draw it
            _ui_elements__WEBPACK_IMPORTED_MODULE_8__.mainCanvas.css('cursor', '');

            (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_3__.removeFX)(fx);

            _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.off('keydown', keydown);
            // globals.eventManager.off('keyup', keyup);
            _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.off('mousedown', mousedown);
            _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.off('mousemove', mousemove);
            _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.off('mouseup', mouseup);

            this.state = 0;

            _camera__WEBPACK_IMPORTED_MODULE_0__["default"].enableMove();
            _player__WEBPACK_IMPORTED_MODULE_6__["default"].restoreColors();
        ...
        function render(ctx) {
            ...
            if (lassoMode) {
                ctx.beginPath();
                const firstCord = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_9__.boardToScreenSpace)(lassoPoints[0][0], lassoPoints[0][1]);
                ctx.moveTo(...firstCord);
                for (let i = 1; i < lassoPoints.length; i++) {
                    const point = lassoPoints[i];
                    ctx.lineTo(...(0,_utils_conversions__WEBPACK_IMPORTED_MODULE_9__.boardToScreenSpace)(...point));
                }
                ctx.closePath();
                ctx.stroke();
            } else {
                const [x1, y1] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_9__.boardToScreenSpace)(startX, startY);
                const [x2, y2] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_9__.boardToScreenSpace)(endX, endY);
        ...
        fx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_3__.FX(render);
        (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_3__.addFX)(fx);
        ...
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.on('keydown', keydown);
        ...
        function onSelected() {
            ...
            maxX = Math.min(maxX, _config__WEBPACK_IMPORTED_MODULE_1__.boardWidth);
            minY = Math.max(minY, 0);
            maxY = Math.min(maxY, _config__WEBPACK_IMPORTED_MODULE_1__.boardHeight);
            ...
            for (let x = 0; x < w; x++) {
                for (let y = 0; y < h; y++) {
                    ...
                    if (lassoMode && !(0,_utils_misc__WEBPACK_IMPORTED_MODULE_10__.testPointInPolygon)(lassoPoints.length, vertx, verty, absX, absY)) {
                        continue;
                    }


                    const isProtected = _globals__WEBPACK_IMPORTED_MODULE_4__["default"].chunkManager.getProtect(absX, absY);
                    protectMask[i / 4] = isProtected;

                    const colId = _globals__WEBPACK_IMPORTED_MODULE_4__["default"].chunkManager.getChunkPixel(absX, absY);
                    const col = _config__WEBPACK_IMPORTED_MODULE_1__.allColors[colId];
            ...
            _paste__WEBPACK_IMPORTED_MODULE_5__.paste.startPlace(canvas, protectMask);
        }
    }
}
const copy = new Copy('copy', 'CTRL+KeyC', null, _constants__WEBPACK_IMPORTED_MODULE_2__.ROLE.MOD);

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (copy);

/***/ },

/***/ "./src/js/tools/ctrlZ.js"
/*!*******************************!*\
  !*** ./src/js/tools/ctrlZ.js ***!
  \*******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _img_toolIcons_revert_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../img/toolIcons/revert.png */ "./src/img/toolIcons/revert.png");
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../globals */ "./src/js/globals.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
...
class CtrlZ extends _Tool__WEBPACK_IMPORTED_MODULE_3__["default"] {
    constructor(...args) {
        super(...args);
    ...
    handlers() {
        ...
        const tick = function () {
            ...
            do {
                ...
                if (_player__WEBPACK_IMPORTED_MODULE_2__["default"].placed.length > _player__WEBPACK_IMPORTED_MODULE_2__["default"].maxPlaced) {
                ...
                if (!_player__WEBPACK_IMPORTED_MODULE_2__["default"].placed.length) return;
                if (!_player__WEBPACK_IMPORTED_MODULE_2__["default"].bucket.spend(1)) return;

                const [x, y, c] = _player__WEBPACK_IMPORTED_MODULE_2__["default"].placed.pop();

                (0,_player__WEBPACK_IMPORTED_MODULE_2__.placePixel)(x, y, c, false, true);
            }
            while (--multiTicks);
        }.bind(this);
...
const ctrlZ = new CtrlZ('ctrlZ', 'KeyZ', _img_toolIcons_revert_png__WEBPACK_IMPORTED_MODULE_0__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ctrlZ);

/***/ },

/***/ "./src/js/tools/floodfill.js"
/*!***********************************!*\
  !*** ./src/js/tools/floodfill.js ***!
  \***********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _toolUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolUtils */ "./src/js/tools/toolUtils.js");
/* harmony import */ var _img_toolIcons_floodfill_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../img/toolIcons/floodfill.png */ "./src/img/toolIcons/floodfill.png");
/* harmony import */ var _camera__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../camera */ "./src/js/camera.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
...
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _utils_camera__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/camera */ "./src/js/utils/camera.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
...
class FloodFill extends _Tool__WEBPACK_IMPORTED_MODULE_7__["default"] {
    constructor(...args) {
        super(...args);
    ...
    up(e, isCancel) {
        ...
        const cord = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_9__.screenToBoardSpace)(e.clientX, e.clientY);
        if ((0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(...cord) === -1 || !(0,_utils_camera__WEBPACK_IMPORTED_MODULE_8__.inBounds)(...cord) || e.type === 'mouseleave') {
            return;
        }
        ...
        this.stack = [
            [_player__WEBPACK_IMPORTED_MODULE_6__["default"].x, _player__WEBPACK_IMPORTED_MODULE_6__["default"].y]
        ];

        this.playerCol = _player__WEBPACK_IMPORTED_MODULE_6__["default"].color;
        this.secondPlayerCol = _player__WEBPACK_IMPORTED_MODULE_6__["default"].secondCol;
        this.fillingCol = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getPixel)(_player__WEBPACK_IMPORTED_MODULE_6__["default"].x, _player__WEBPACK_IMPORTED_MODULE_6__["default"].y);
    }
    ...
    down(e) {
        ...
        const cord = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_9__.screenToBoardSpace)(e.clientX, e.clientY);
        if ((0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(...cord) === -1 || !(0,_utils_camera__WEBPACK_IMPORTED_MODULE_8__.inBounds)(...cord)) {
            return;
        }
        let _lastX, _lastY;
        ...
        let fx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_4__.FX(tick.bind(this));
        (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_4__.addFX)(fx, 0);
        ...
        function restart() {
            ...
            _lastX = _player__WEBPACK_IMPORTED_MODULE_6__["default"].x;
            _lastY = _player__WEBPACK_IMPORTED_MODULE_6__["default"].y;
        ...
        function paint() {
            ...
            let color = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(x, y, this.playerCol, this.secondPlayerCol);
            let tileCol = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getPixel)(x, y);
            let painted = this.showedPixels.indexOf(x + ',' + y) !== -1;

            if (painted || tileCol === color || tileCol !== this.fillingCol || !(0,_utils_camera__WEBPACK_IMPORTED_MODULE_8__.inBounds)(x, y)) {
                return 0;
            }
        ...
        function tick(ctx) {
            if (_globals__WEBPACK_IMPORTED_MODULE_5__["default"].mobile && _globals__WEBPACK_IMPORTED_MODULE_5__["default"].toolManager.tool !== this) {
                this.up({}, true);
                return 1;
            }
            if (_player__WEBPACK_IMPORTED_MODULE_6__["default"].x != _lastX || _player__WEBPACK_IMPORTED_MODULE_6__["default"].y != _lastY) {
                restart.call(this);
            }
            if ((0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getCurCol)() === -1) return 1;
            ...
            ctx.strokeWidth = _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom;
            ...
            this.showedPixels.forEach((p, i) => {
                ...
                const color = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(x, y, this.playerCol, this.secondPlayerCol);
                ctx.strokeStyle = _config__WEBPACK_IMPORTED_MODULE_3__.hexPalette[color];

                let [absX, absY] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_9__.boardToScreenSpace)(x, y);
                ctx.strokeRect(absX, absY, _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom, _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom);
            });
    ...
    checkP(x, y) {
        if ((0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getPixel)(x, y) !== this.fillingCol) return false;
    ...
    tick() {
        ...
        for (let i = 0; i < 15 && this.stack.length; i++) {
            ...
            if (!_player__WEBPACK_IMPORTED_MODULE_6__["default"].bucket.spend(1)) break;
            ...
            if (tileCol === color || tileCol !== this.fillingCol || !(0,_utils_camera__WEBPACK_IMPORTED_MODULE_8__.inBounds)(x, y)) {
                continue;
            }
            ...
            (0,_player__WEBPACK_IMPORTED_MODULE_6__.placePixel)(x, y, color);
        }
...
const floodfill = new FloodFill('floodfill', 'KeyF', _img_toolIcons_floodfill_png__WEBPACK_IMPORTED_MODULE_1__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (floodfill);

/***/ },

/***/ "./src/js/tools/gradient.js"
/*!**********************************!*\
  !*** ./src/js/tools/gradient.js ***!
  \**********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _toolUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolUtils */ "./src/js/tools/toolUtils.js");
/* harmony import */ var _img_toolIcons_wand_cur_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../img/toolIcons/wand-cur.png */ "./src/img/toolIcons/wand-cur.png");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
/* harmony import */ var _fxcanvas__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../fxcanvas */ "./src/js/fxcanvas.js");
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../globals */ "./src/js/globals.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _utils_color__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/color */ "./src/js/utils/color.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
/* harmony import */ var _utils_misc__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/misc */ "./src/js/utils/misc.js");
/* harmony import */ var _utils_webGL__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/webGL */ "./src/js/utils/webGL.js");
/* harmony import */ var _convert_matrices_bayer__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../convert/matrices/bayer */ "./src/js/convert/matrices/bayer.js");
/* harmony import */ var _camera__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../camera */ "./src/js/camera.js");
/* harmony import */ var _MiniWindow__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../MiniWindow */ "./src/js/MiniWindow.js");
/* harmony import */ var _translate__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../translate */ "./src/js/translate.js");
/* harmony import */ var _utils_strings__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../utils/strings */ "./src/js/utils/strings.js");
/* harmony import */ var _utils_localStorage__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../utils/localStorage */ "./src/js/utils/localStorage.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
function ditherGradient(ctx, color1, color2, matrixSize, gradientProps) {
    const matrix = _convert_matrices_bayer__WEBPACK_IMPORTED_MODULE_11__["default"][matrixSize];
...
function selectColor(ctx, rgb, startX, startY, floodfillMode) {
    ...
    const targetAbgr = (0,_utils_color__WEBPACK_IMPORTED_MODULE_7__.rgb2abgr)(...rgb);
...
class Gradient extends _Tool__WEBPACK_IMPORTED_MODULE_6__["default"] {
    constructor(...args) {
        super(...args);
        ...
        this.options = {
            globalMaxRadius: 10,
            fillMode: parseInt((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_16__.getLS)('grad:fill_mode') || FILL_MODE.FLOODFILL),
            isRadial: (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_16__.getLS)('grad:radial') === 'true',
            magnetMode: (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_16__.getLS)('grad:magnet_mode') === 'true',
            matrixSize: parseInt((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_16__.getLS)('grad:matrix_size') || 2)
        }
    ...
    showSubmenu() {
        const menuWin = new _MiniWindow__WEBPACK_IMPORTED_MODULE_13__["default"]((0,_translate__WEBPACK_IMPORTED_MODULE_14__.translate)('gradient'), 2, true);
        const body = $(
            `<div>
            <select id="gradientFillMode">
                <option value="${FILL_MODE.GLOBAL}">
                    ${(0,_translate__WEBPACK_IMPORTED_MODULE_14__.translate)('fill_mode.global')}
                </option>
                <option value="${FILL_MODE.FLOODFILL}">
                    ${(0,_translate__WEBPACK_IMPORTED_MODULE_14__.translate)('fill_mode.floodfill')}
                </option>
            </select><br>
            ${(0,_utils_strings__WEBPACK_IMPORTED_MODULE_15__.capitalize)((0,_translate__WEBPACK_IMPORTED_MODULE_14__.translate)('bayer'))}: <select id="gradientMatrixSize">
                <option value="2">
                    2
                </option>
                <option value="4">
            ...
            <label for="gradientIsRadial">${(0,_utils_strings__WEBPACK_IMPORTED_MODULE_15__.capitalize)((0,_translate__WEBPACK_IMPORTED_MODULE_14__.translate)('radial'))}:</label><input type="checkbox" id="gradientIsRadial">
            <label for="gradientMagnetMode">${(0,_utils_strings__WEBPACK_IMPORTED_MODULE_15__.capitalize)((0,_translate__WEBPACK_IMPORTED_MODULE_14__.translate)('magnet_mode'))}:</label><input type="checkbox" id="gradientMagnetMode">
            </div>`
        );
        ...
        fillModeSel.on('change', e => {
            ...
            (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_16__.setLS)('grad:fill_mode', fillModeSel.val());
            this.updatePreview();
        });
        ...
        bayerSizeSel.on('change', e => {
            ...
            (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_16__.setLS)('grad:matrix_size', bayerSizeSel.val());
            this.updatePreview();
        });
        ...
        isRadialCb.on('change', e => {
            ...
            (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_16__.setLS)('grad:radial', isRadialCb.is(':checked'));
            this.updatePreview();
        });
        ...
        magnetModeCb.on('change', e => {
            ...
            (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_16__.setLS)('grad:magnet_mode', magnetModeCb.is(':checked'));
            this.updatePreview();
        });
    ...
    up() {
        if (_toolUtils__WEBPACK_IMPORTED_MODULE_0__.mobile) return;
    ...
    mousedown(e) {
        _camera__WEBPACK_IMPORTED_MODULE_12__["default"].disableMove();
        if (this.firstPointPos) {
            const distToFirstPoint = distXY((0,_utils_conversions__WEBPACK_IMPORTED_MODULE_8__.boardToScreenSpace)(this.firstPointPos[0] + 0.5, this.firstPointPos[1] + 0.5), [e.clientX, e.clientY]);
            if (distToFirstPoint < 10) {
                this.movingFirstPoint = true;
                return;
            }

            const distToSecondPoint = distXY((0,_utils_conversions__WEBPACK_IMPORTED_MODULE_8__.boardToScreenSpace)(this.secondPointPos[0] + 0.5, this.secondPointPos[1] + 0.5), [e.clientX, e.clientY]);
            if (distToSecondPoint < 10) {
                this.movingSecondPoint = true;
                return;
            }
        } else {
            this.firstPointPos = [_player__WEBPACK_IMPORTED_MODULE_5__["default"].x, _player__WEBPACK_IMPORTED_MODULE_5__["default"].y];
            this.selectedColor = _globals__WEBPACK_IMPORTED_MODULE_4__["default"].chunkManager.getChunkPixel(_player__WEBPACK_IMPORTED_MODULE_5__["default"].x, _player__WEBPACK_IMPORTED_MODULE_5__["default"].y);
        }
    }
    ...
    mousemove(e) {
        ...
        if (this.movingFirstPoint) {
            ...
            if (this.firstPointPos?.at(0) === _player__WEBPACK_IMPORTED_MODULE_5__["default"].x && this.firstPointPos?.at(1) === _player__WEBPACK_IMPORTED_MODULE_5__["default"].y) return;
            ...
            if (this.secondPointPos?.at(0) === _player__WEBPACK_IMPORTED_MODULE_5__["default"].x && this.secondPointPos?.at(1) === _player__WEBPACK_IMPORTED_MODULE_5__["default"].y) return;

            let secondPoint = [_player__WEBPACK_IMPORTED_MODULE_5__["default"].x, _player__WEBPACK_IMPORTED_MODULE_5__["default"].y];
    ...
    mouseup(e) {
        _camera__WEBPACK_IMPORTED_MODULE_12__["default"].enableMove();
    ...
    addMouseListeners() {
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.on('mousedown', this.mouseListeners.down);
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.on('mousemove', this.mouseListeners.move);
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.on('mouseup', this.mouseListeners.up);
    }

    removeMouseListeners() {
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.off('mousedown', this.mouseListeners.down);
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.off('mousemove', this.mouseListeners.move);
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.off('mouseup', this.mouseListeners.up);
    }
    ...
    addFx() {
        ...
        this.fx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_3__.FX(ctx => {
            if (!this.firstPointPos || !this.secondPointPos) {
                return _fxcanvas__WEBPACK_IMPORTED_MODULE_3__.FX_STATE.FINISHED;
            }

            //actual gradient drawing
            if (this.previewCanvas) {
                ctx.globalAlpha = 1;
                const screenPos = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_8__.boardToScreenSpace)(this.previewProps.x, this.previewProps.y);
                ctx.drawImage(
                    this.previewCanvas,
                    0, 0, this.previewProps.w, this.previewProps.h,
                    screenPos[0], screenPos[1], this.previewProps.w * _camera__WEBPACK_IMPORTED_MODULE_12__["default"].zoom, this.previewProps.h * _camera__WEBPACK_IMPORTED_MODULE_12__["default"].zoom
                );
                ctx.globalAlpha = 1;
            }
            ...
            const firstPos = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_8__.boardToScreenSpace)(this.firstPointPos[0] + 0.5, this.firstPointPos[1] + 0.5);
            const secondPos = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_8__.boardToScreenSpace)(this.secondPointPos[0] + 0.5, this.secondPointPos[1] + 0.5);
        ...
        (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_3__.addFX)(this.fx);
    }
    removeFx() {
        (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_3__.removeFX)(this.fx);
        this.fx = null;
    }
    ...
    updatePreview() {
        ...
        const firstColHex = _config__WEBPACK_IMPORTED_MODULE_2__.hexPalette[_player__WEBPACK_IMPORTED_MODULE_5__["default"].color] ?? '#00000000';
        const secondColHex = _config__WEBPACK_IMPORTED_MODULE_2__.hexPalette[_player__WEBPACK_IMPORTED_MODULE_5__["default"].secondCol] ?? '#00000000';
        ...
        const firstColRgb = _config__WEBPACK_IMPORTED_MODULE_2__.allColors[_player__WEBPACK_IMPORTED_MODULE_5__["default"].color] ?? null;
        const secondColRgb = _config__WEBPACK_IMPORTED_MODULE_2__.allColors[_player__WEBPACK_IMPORTED_MODULE_5__["default"].secondCol] ?? null;
        ...
        const boardDump = _globals__WEBPACK_IMPORTED_MODULE_4__["default"].chunkManager.dumpZone(
            this.previewProps.x,
            this.previewProps.y,
            this.previewProps.w,
            this.previewProps.h
        ...
        selectColor(dumpCtx,
            _config__WEBPACK_IMPORTED_MODULE_2__.allColors[this.selectedColor],
            firstOffX, firstOffY,
    ...
    drawRendered(){
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].toolManager.tools.paste.startDraw(this.previewCanvas, this.previewProps.x, this.previewProps.y);
    }
}
const gradient = new Gradient('gradient', 'KeyB', _img_toolIcons_wand_cur_png__WEBPACK_IMPORTED_MODULE_1__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (gradient);


/***/ },

/***/ "./src/js/tools/grid.js"
/*!******************************!*\
  !*** ./src/js/tools/grid.js ***!
  \******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class Grid extends _Tool__WEBPACK_IMPORTED_MODULE_3__["default"] {
    constructor(...args) {
        super(...args);
        ...
        _camera__WEBPACK_IMPORTED_MODULE_0__["default"].on('zoom', () => {
            if (this.state == 1) {
                this.tryRender();
            }
        });
        ...
        if (JSON.parse((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_5__.getOrDefault)('enableGrid', false))) {
            this.show();
        }
    }
    ...
    /**@param {CanvasRenderingContext2D} ctx*/
    drawGrid(ctx) {
        let [x, y] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_4__.screenToBoardSpace)(0, 0), [clientX, clientY] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_4__.boardToScreenSpace)(x, y);
        ...
        const calculatedAlpha = zoom > 16 ? 0.5 : (0,_utils_math__WEBPACK_IMPORTED_MODULE_6__.mapRange)(zoom, 24, 5, 0.5, 0);
        ctx.globalAlpha = calculatedAlpha;

        let thickInterval;
        if (_config__WEBPACK_IMPORTED_MODULE_1__.chunkSize % 16 == 0) thickInterval = 16;
        else if (_config__WEBPACK_IMPORTED_MODULE_1__.chunkSize % 10 == 0) thickInterval = 10;
        ...
        for (; clientX < width; clientX += zoom) {
            ...
            if (x % _config__WEBPACK_IMPORTED_MODULE_1__.chunkSize == 0) wid = 1;
        ...
        for (; clientY < height; clientY += zoom) {
            ...
            if (y % _config__WEBPACK_IMPORTED_MODULE_1__.chunkSize == 0) wid = 1;
    ...
    tryRender() {
        if (!this.fx || this.fx.removed) {
            this.fx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_2__.FX(this.render.bind(this));
            (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_2__.addFX)(this.fx, 2);
        }
    }
    ...
    toggle() {
        ...
        (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_5__.setLS)('enableGrid', (!!this.state).toString());
    }
    ...
    hide() {
        this.state = 0;
        this.fx && (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_2__.removeFX)(this.fx);
    }

    render(ctx) {
        if (_camera__WEBPACK_IMPORTED_MODULE_0__["default"].zoom <= 5) return 1;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _clicker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./clicker */ "./src/js/tools/clicker.js");
/* harmony import */ var _mover__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mover */ "./src/js/tools/mover.js");
/* harmony import */ var _floodfill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./floodfill */ "./src/js/tools/floodfill.js");
/* harmony import */ var _pipettes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pipettes */ "./src/js/tools/pipettes.js");
/* harmony import */ var _line__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./line */ "./src/js/tools/line.js");
/* harmony import */ var _nextColor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./nextColor */ "./src/js/tools/nextColor.js");
/* harmony import */ var _colorSwap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./colorSwap */ "./src/js/tools/colorSwap.js");
/* harmony import */ var _uiToggles__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./uiToggles */ "./src/js/tools/uiToggles.js");
/* harmony import */ var _ctrlZ__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ctrlZ */ "./src/js/tools/ctrlZ.js");
/* harmony import */ var _protectors__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./protectors */ "./src/js/tools/protectors.js");
/* harmony import */ var _grid__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./grid */ "./src/js/tools/grid.js");
/* harmony import */ var _copy__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./copy */ "./src/js/tools/copy.js");
/* harmony import */ var _paste__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./paste */ "./src/js/tools/paste.js");
/* harmony import */ var _sendCoords__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./sendCoords */ "./src/js/tools/sendCoords.js");
/* harmony import */ var _templateToggles__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./templateToggles */ "./src/js/tools/templateToggles.js");
/* harmony import */ var _square__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./square */ "./src/js/tools/square.js");
/* harmony import */ var _brushSize__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./brushSize */ "./src/js/tools/brushSize.js");
/* harmony import */ var _pixelInfo__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./pixelInfo */ "./src/js/tools/pixelInfo.js");
/* harmony import */ var _text__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./text */ "./src/js/tools/text.js");
/* harmony import */ var _resetColors__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./resetColors */ "./src/js/tools/resetColors.js");
/* harmony import */ var _wand__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./wand */ "./src/js/tools/wand.js");
/* harmony import */ var _mnkbm__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./mnkbm */ "./src/js/tools/mnkbm.js");
/* harmony import */ var _paletteSwapper__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./paletteSwapper */ "./src/js/tools/paletteSwapper.js");
/* harmony import */ var _gradient__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./gradient */ "./src/js/tools/gradient.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    clicker: _clicker__WEBPACK_IMPORTED_MODULE_0__["default"],
    mover: _mover__WEBPACK_IMPORTED_MODULE_1__["default"],
    floodfill: _floodfill__WEBPACK_IMPORTED_MODULE_2__["default"],
    pipette: _pipettes__WEBPACK_IMPORTED_MODULE_3__.pipette, altPipette: _pipettes__WEBPACK_IMPORTED_MODULE_3__.altPipette,
    line: _line__WEBPACK_IMPORTED_MODULE_4__["default"],
    colorInc: _nextColor__WEBPACK_IMPORTED_MODULE_5__.colorInc, colorDec: _nextColor__WEBPACK_IMPORTED_MODULE_5__.colorDec,
    colorSwap: _colorSwap__WEBPACK_IMPORTED_MODULE_6__["default"],
    chatOpac: _uiToggles__WEBPACK_IMPORTED_MODULE_7__.chatOpac, menuOpac: _uiToggles__WEBPACK_IMPORTED_MODULE_7__.menuOpac, allOpac: _uiToggles__WEBPACK_IMPORTED_MODULE_7__.allOpac,
    ctrlZ: _ctrlZ__WEBPACK_IMPORTED_MODULE_8__["default"],
    protector: _protectors__WEBPACK_IMPORTED_MODULE_9__.protector, altProtector: _protectors__WEBPACK_IMPORTED_MODULE_9__.altProtector,
    grid: _grid__WEBPACK_IMPORTED_MODULE_10__["default"],
    copy: _copy__WEBPACK_IMPORTED_MODULE_11__["default"],
    paste: _paste__WEBPACK_IMPORTED_MODULE_12__["default"],
    cordAdd: _sendCoords__WEBPACK_IMPORTED_MODULE_13__["default"],
    templateOp1: _templateToggles__WEBPACK_IMPORTED_MODULE_14__.templateOp1, templateOp2: _templateToggles__WEBPACK_IMPORTED_MODULE_14__.templateOp2,
    square: _square__WEBPACK_IMPORTED_MODULE_15__["default"],
    incBrush: _brushSize__WEBPACK_IMPORTED_MODULE_16__.incBrush, decBrush: _brushSize__WEBPACK_IMPORTED_MODULE_16__.decBrush,
    pixelInfo: _pixelInfo__WEBPACK_IMPORTED_MODULE_17__["default"],
    text: _text__WEBPACK_IMPORTED_MODULE_18__["default"],
    resetColors: _resetColors__WEBPACK_IMPORTED_MODULE_19__["default"],
    wand: _wand__WEBPACK_IMPORTED_MODULE_20__["default"],
    colorador: _mnkbm__WEBPACK_IMPORTED_MODULE_21__["default"],
    paletteSwapper: _paletteSwapper__WEBPACK_IMPORTED_MODULE_22__["default"],
    gradient: _gradient__WEBPACK_IMPORTED_MODULE_23__["default"]
});
...
/* harmony export */ });
/* harmony import */ var _toolUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolUtils */ "./src/js/tools/toolUtils.js");
/* harmony import */ var _img_toolIcons_line_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../img/toolIcons/line.png */ "./src/img/toolIcons/line.png");
/* harmony import */ var _camera__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../camera */ "./src/js/camera.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../constants */ "./src/js/constants.js");
/* harmony import */ var _fxcanvas__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../fxcanvas */ "./src/js/fxcanvas.js");
...
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
/* harmony import */ var _utils_localStorage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/localStorage */ "./src/js/utils/localStorage.js");
/* harmony import */ var _utils_shapes__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/shapes */ "./src/js/utils/shapes.js");
...
class Line extends _Tool__WEBPACK_IMPORTED_MODULE_9__["default"] {
    constructor(...args) {
        super(...args);

        this.drawLength = JSON.parse((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_11__.getOrDefault)('drawLineLen', false));;
    ...
    handlers() {
        ...
        function down(e) {
            ...
            startCoords = [_player__WEBPACK_IMPORTED_MODULE_8__["default"].x, _player__WEBPACK_IMPORTED_MODULE_8__["default"].y];

            [startColor1, startColor2] = [_player__WEBPACK_IMPORTED_MODULE_8__["default"].color, _player__WEBPACK_IMPORTED_MODULE_8__["default"].secondCol];

            startCircleSize = 1;
            if (_player__WEBPACK_IMPORTED_MODULE_8__["default"].brushSize !== 1) {
                startCircleSize = _globals__WEBPACK_IMPORTED_MODULE_6__["default"].renderer.preRendered.brush.circle.length;
            }
        ...
        function move(e) {
            ...
            endCoords = [_player__WEBPACK_IMPORTED_MODULE_8__["default"].x, _player__WEBPACK_IMPORTED_MODULE_8__["default"].y];

            if (_player__WEBPACK_IMPORTED_MODULE_8__["default"].color === -1 && _player__WEBPACK_IMPORTED_MODULE_8__["default"].secondCol === -1) {
                fx && (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_5__.removeFX)(fx);
                return;
            }
            if (endCoords[0] != lastCoords[0] || endCoords[1] != lastCoords[1]) {
                ...
                fx && (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_5__.removeFX)(fx);
                fx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_5__.FX((ctx) => {
                    ctx.globalAlpha = .5;
                    ...
                    line.forEach(([x, y]) => {
                        ...
                        let [screenX, screenY] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_10__.boardToScreenSpace)(x, y);
                        ctx.fillRect(screenX, screenY, _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom, _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom);
                    });

                    // draw (non pixelated) black line over the line
                    ctx.strokeStyle = '#000000';
                    ctx.lineWidth = _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom / 5;

                    const startScreen = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_10__.boardToScreenSpace)(...line[0]);
                    const endScreen = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_10__.boardToScreenSpace)(...line[line.length - 1]);

                    ctx.beginPath();
                    ctx.lineCap = 'round';
                    ctx.moveTo(...startScreen.map(z => z += _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom / 2));
                    ctx.lineTo(...endScreen.map(z => z += _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom / 2));
                    ...
                    if (this.drawLength && line.length > 1) {
                        ...
                        midPosX += _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom * 0.5;
                        midPosY += _camera__WEBPACK_IMPORTED_MODULE_2__["default"].zoom * 0.5;
                ...
                (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_5__.addFX)(fx);
            }
        }
        ...
        function buildLine(x1, y1, x2, y2) {
            ...
            const w = _config__WEBPACK_IMPORTED_MODULE_3__.boardWidth;

            // to not repeat already added pixels
            const placed = new Set();

            const bruhLinePixels = [];
            const linePixels = _utils_shapes__WEBPACK_IMPORTED_MODULE_12__["default"].line(x1, y1, x2, y2);
        ...
        function up() {
            ...
            if (!endCoords) endCoords = [_player__WEBPACK_IMPORTED_MODULE_8__["default"].x, _player__WEBPACK_IMPORTED_MODULE_8__["default"].y];

            line = buildLine(...startCoords, ...endCoords);

            if (line.length > 150 && _me__WEBPACK_IMPORTED_MODULE_7__["default"].role < _constants__WEBPACK_IMPORTED_MODULE_4__.ROLE.TRUSTED) {
                return;
            }
        ...
        function tick() {
            ...
            while (true) {
                ...
                const [x, y] = line.pop();
                const col = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(x, y, startColor1, startColor2);

                if (col === undefined || col === -1) return this.off('tick', tick);
                if (!(0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.checkBounds)(x, y) || (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getPixel)(x, y) === col) continue;

                if (!_player__WEBPACK_IMPORTED_MODULE_8__["default"].bucket.spend(1)) return line.push([x, y]);

                (0,_player__WEBPACK_IMPORTED_MODULE_8__.placePixel)(x, y, col);
                placed++;
        ...
        _globals__WEBPACK_IMPORTED_MODULE_6__["default"].toolManager.on('move', move);
        this.on('up', up);
    }
}
const line = new Line('line', 'ShiftLeft', _img_toolIcons_line_png__WEBPACK_IMPORTED_MODULE_1__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (line);

/***/ },

/***/ "./src/js/tools/mnkbm.js"
/*!*******************************!*\
  !*** ./src/js/tools/mnkbm.js ***!
  \*******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   COLORADOR_STATE: () => (/* binding */ COLORADOR_STATE),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _toolUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolUtils */ "./src/js/tools/toolUtils.js");
/* harmony import */ var _img_disabled_color_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../img/disabled-color.svg */ "./src/img/disabled-color.svg");
/* harmony import */ var _img_toolIcons_disable_cur_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../img/toolIcons/disable-cur.png */ "./src/img/toolIcons/disable-cur.png");
/* harmony import */ var _img_toolIcons_disable_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../img/toolIcons/disable.png */ "./src/img/toolIcons/disable.png");
...
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../template */ "./src/js/template.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _translate__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../translate */ "./src/js/translate.js");
/* harmony import */ var _ui_elements__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../ui/elements */ "./src/js/ui/elements.js");
/* harmony import */ var _utils_color__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/color */ "./src/js/utils/color.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
...
/* harmony import */ var _utils_webGL__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../utils/webGL */ "./src/js/utils/webGL.js");
/* provided dependency */ var toastr = __webpack_require__(/*! toastr */ "./node_modules/toastr/toastr.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
class TemplateColorador extends _Tool__WEBPACK_IMPORTED_MODULE_9__["default"] {
    constructor(...args) {
        super(...args);

        this.colorsWhitelist = [];
        (0,_config__WEBPACK_IMPORTED_MODULE_4__.resolveWhenConfigDownloaded)().then(() => {
            this.colorsWhitelist = JSON.parse((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_14__.getOrDefault)('coloradorColors', '[]', true));
            if (this.colorsWhitelist.length) {
                (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_5__.addFX)(new _fxcanvas__WEBPACK_IMPORTED_MODULE_5__.FX(() => {
                    if (!_template__WEBPACK_IMPORTED_MODULE_8__["default"].templateImg?.width) return _fxcanvas__WEBPACK_IMPORTED_MODULE_5__.FX_STATE.IN_PROCESS;

                    try {
                        this.update();
                    } catch (error) { }

                    return _fxcanvas__WEBPACK_IMPORTED_MODULE_5__.FX_STATE.REMOVED;
                }));
            }
        });
    ...
    mmb(colorId) {
        this.toggleWhitelistColor(_config__WEBPACK_IMPORTED_MODULE_4__.allColors[colorId]);
    }
    ...
    mouseup(e) {
        try {
            ...
            if (!(0,_utils_misc__WEBPACK_IMPORTED_MODULE_15__.isClick)(this.downPos, upPos)) {
                return;
            }

            this.regenerateTemplateIfNeeded();

            const boardPos = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_13__.screenToBoardSpace)(...upPos);
            ...
            const templateColId = (0,_utils_color__WEBPACK_IMPORTED_MODULE_12__.getPaletteColorId)(templateCol);
            if (templateColId === -1) {
                toastr.warning((0,_translate__WEBPACK_IMPORTED_MODULE_10__.translate)('color_not_in_palette'));
                return;
            }
    ...
    isOutsideTemplate(boardX, boardY) {
        const div = _template__WEBPACK_IMPORTED_MODULE_8__["default"].isPatterns ? 7 : 1;
        const templateW = _template__WEBPACK_IMPORTED_MODULE_8__["default"].templateImg.width / div;
        const templateH = _template__WEBPACK_IMPORTED_MODULE_8__["default"].templateImg.height / div;

        return boardX < _template__WEBPACK_IMPORTED_MODULE_8__["default"].x || boardY < _template__WEBPACK_IMPORTED_MODULE_8__["default"].y ||
            boardX >= _template__WEBPACK_IMPORTED_MODULE_8__["default"].x + templateW ||
            boardY >= _template__WEBPACK_IMPORTED_MODULE_8__["default"].y + templateH;
    }
    ...
    getTemplateColor(boardX, boardY) {
        ...
        const temX = boardX - _template__WEBPACK_IMPORTED_MODULE_8__["default"].x;
        const temY = boardY - _template__WEBPACK_IMPORTED_MODULE_8__["default"].y;

        let color = null;
        if (!_template__WEBPACK_IMPORTED_MODULE_8__["default"].isPatterns) {
    ...
    updateUIPalette() {
        ...
        $(`.paletteColor`).append(`<img src="${_img_disabled_color_svg__WEBPACK_IMPORTED_MODULE_1__["default"]}" class="disabledClr">`);

        for (const rgb of this.colorsWhitelist) {
            const id = (0,_utils_color__WEBPACK_IMPORTED_MODULE_12__.getPaletteColorId)(rgb);
            if (id === -1) {
    ...
    update() {
        (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_14__.setLS)('coloradorColors', JSON.stringify(this.colorsWhitelist), true);
    ...
    regenerateTemplateIfNeeded() {
        if (!this.origTemplateCanvas || !this.templateCanvas || this.templateCanvas !== _template__WEBPACK_IMPORTED_MODULE_8__["default"].templateImg) {
            this.templateUpdated = true;
            this.glData.gl = null;

            const templateImg = _template__WEBPACK_IMPORTED_MODULE_8__["default"].templateImg;
    ...
    startSelecting() {
        ...
        this.changeCursor(1);
        _player__WEBPACK_IMPORTED_MODULE_7__["default"].suspendColors();

        this.clearListeners();

        _globals__WEBPACK_IMPORTED_MODULE_6__["default"].eventManager.on('mousedown', this.mouseListeners.down);
        _globals__WEBPACK_IMPORTED_MODULE_6__["default"].eventManager.on('mouseup', this.mouseListeners.up);
    ...
    stopSelecting() {
        ...
        this.changeCursor(0);
        _player__WEBPACK_IMPORTED_MODULE_7__["default"].restoreColors();
    ...
    clearListeners() {
        _globals__WEBPACK_IMPORTED_MODULE_6__["default"].eventManager.off('mousedown', this.mouseListeners.down);
        _globals__WEBPACK_IMPORTED_MODULE_6__["default"].eventManager.off('mouseup', this.mouseListeners.up);
    }
    ...
    render(drawDisabled) {
        ...
        let cpuFallback = (w > _utils_webGL__WEBPACK_IMPORTED_MODULE_16__.MAX_TEX_SIZE || h > _utils_webGL__WEBPACK_IMPORTED_MODULE_16__.MAX_TEX_SIZE);
    ...
    renderShader(drawDisabled) {
        ...
        gl.uniform2f(this.glData.screenSizeLoc, _ui_elements__WEBPACK_IMPORTED_MODULE_11__.mainCanvas.width, _ui_elements__WEBPACK_IMPORTED_MODULE_11__.mainCanvas.height);
    ...
    generateShader() {
        ...
        const { gl, program, texture } = (0,_utils_webGL__WEBPACK_IMPORTED_MODULE_16__.generateShader)(existingGl ?? this.templateCanvas, fragmentShader, existingGl ? false : true);
    ...
    patchTemplate() {
        _template__WEBPACK_IMPORTED_MODULE_8__["default"].templateImg = this.templateCanvas;
        _globals__WEBPACK_IMPORTED_MODULE_6__["default"].fxRenderer.needRender = true;
    }
    unpatchTemplate() {
        _template__WEBPACK_IMPORTED_MODULE_8__["default"].templateImg = this.origTemplateCanvas;
        _globals__WEBPACK_IMPORTED_MODULE_6__["default"].fxRenderer.needRender = true;
    }

    changeCursor(cursorState) {
        if (cursorState === 1) {
            document.body.style.cursor = `url('${_img_toolIcons_disable_cur_png__WEBPACK_IMPORTED_MODULE_2__["default"]}') 0 0, auto`;
        } else {
            document.body.style.cursor = '';
        }
    }
...
const colorador = new TemplateColorador('colorador', 'KeyD', _img_toolIcons_disable_png__WEBPACK_IMPORTED_MODULE_3__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (colorador);

/***/ },

/***/ "./src/js/tools/mover.js"
/*!*******************************!*\
  !*** ./src/js/tools/mover.js ***!
  \*******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _toolUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolUtils */ "./src/js/tools/toolUtils.js");
/* harmony import */ var _pixelInfo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pixelInfo */ "./src/js/tools/pixelInfo.js");
/* harmony import */ var _img_toolIcons_move_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../img/toolIcons/move.png */ "./src/img/toolIcons/move.png");
/* harmony import */ var _camera__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../camera */ "./src/js/camera.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
/* harmony import */ var _fxcanvas__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../fxcanvas */ "./src/js/fxcanvas.js");
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../globals */ "./src/js/globals.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _ui_elements__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../ui/elements */ "./src/js/ui/elements.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
...
class Mover extends _Tool__WEBPACK_IMPORTED_MODULE_8__["default"] {
    constructor(...args) {
        super(...args);
        ...
        if (!_toolUtils__WEBPACK_IMPORTED_MODULE_0__.mobile) {
            ...
            (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_5__.addFX)(this.fx, 2);
        }
    }
    ...
    renderCursor(ctx) {
        ...
        const color = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getCurCol)();

        if (~color && zoom > 1) {
            if (_player__WEBPACK_IMPORTED_MODULE_7__["default"].brushSize == 1) {
                let [x, y] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_10__.boardToScreenSpace)(_player__WEBPACK_IMPORTED_MODULE_7__["default"].x, _player__WEBPACK_IMPORTED_MODULE_7__["default"].y);
                ...
                if (_player__WEBPACK_IMPORTED_MODULE_7__["default"].brushSize % 2 === 0) {
                    offX = 1;
                    offY = 1;
                }
                const center = _player__WEBPACK_IMPORTED_MODULE_7__["default"].brushSize / 2;
                const [x, y] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_10__.boardToScreenSpace)(_player__WEBPACK_IMPORTED_MODULE_7__["default"].x - center + offX, _player__WEBPACK_IMPORTED_MODULE_7__["default"].y - center + offY);
                ctx.drawImage(_globals__WEBPACK_IMPORTED_MODULE_6__["default"].renderer.preRendered.brush.canvas, x, y);
            }
        }
    ...
    down(e) {
        ...
        (0,_ui_elements__WEBPACK_IMPORTED_MODULE_9__.changeSelector)('#ui>div>*', { 'pointer-events': 'none' });

        this.downPos = this.lastPos = [e.clientX, e.clientY];
        this.antijitterDownPos = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_10__.screenToBoardSpace)(e.clientX, e.clientY);
    ...
    up(e) {
        ...
        (0,_ui_elements__WEBPACK_IMPORTED_MODULE_9__.changeSelector)('#ui>div>*', { 'pointer-events': 'all' });
        this.antijitterDownPos = null;

        // long tap to get pixel info
        if (_toolUtils__WEBPACK_IMPORTED_MODULE_0__.mobile && this.moveThreshold() && !e.gesture) {
            const ela = Date.now() - this.downTime;
            if (ela < 1000) return;

            _pixelInfo__WEBPACK_IMPORTED_MODULE_1__["default"].emit('up');
        }
    }
    ...
    move(e) {
        ...
        if (this.lastPlayerPos[0] != _player__WEBPACK_IMPORTED_MODULE_7__["default"].x ||
            this.lastPlayerPos[1] != _player__WEBPACK_IMPORTED_MODULE_7__["default"].y ||
            this.mousedown) {
            (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.renderFX)();
        }

        
        this.lastPlayerPos = [_player__WEBPACK_IMPORTED_MODULE_7__["default"].x, _player__WEBPACK_IMPORTED_MODULE_7__["default"].y];
        ...
        _camera__WEBPACK_IMPORTED_MODULE_3__["default"].moveBy(-e.movementX / _camera__WEBPACK_IMPORTED_MODULE_3__["default"].zoom /* / devicePixelRatio */, -e.movementY / _camera__WEBPACK_IMPORTED_MODULE_3__["default"].zoom /* / devicePixelRatio */);
    }
...
const mover = new Mover('mover', 'LMB', _img_toolIcons_move_png__WEBPACK_IMPORTED_MODULE_2__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (mover);

/***/ },

/***/ "./src/js/tools/nextColor.js"
/*!***********************************!*\
  !*** ./src/js/tools/nextColor.js ***!
  \***********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   colorDec: () => (/* binding */ colorDec),
/* harmony export */   colorInc: () => (/* binding */ colorInc)
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
...
colorDec.on('down', function () {
    const minIndex = _config__WEBPACK_IMPORTED_MODULE_0__.currentPalette?.slice[0] ?? 0;
    const maxIndex = _config__WEBPACK_IMPORTED_MODULE_0__.currentPalette?.slice[1] ?? _config__WEBPACK_IMPORTED_MODULE_0__.allColors.length;

    let color = _player__WEBPACK_IMPORTED_MODULE_1__["default"].color - 1;
    if (color < minIndex) color = maxIndex - 1;

    // palette overflow fix
    color = Math.min(maxIndex - 1, Math.max(minIndex, color));

    _player__WEBPACK_IMPORTED_MODULE_1__["default"].switchColor(color);
});
...
/***/ "./src/js/tools/paletteSwapper.js"
/*!****************************************!*\
  !*** ./src/js/tools/paletteSwapper.js ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _ui_palette__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../ui/palette */ "./src/js/ui/palette.js");





const paletteSwapper = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('palette_swap', 'KeyH');
paletteSwapper.on('down', function () {
    const allPalettes = _config__WEBPACK_IMPORTED_MODULE_0__.palettes;
    if (!allPalettes) return;

    let paletteIdx = _config__WEBPACK_IMPORTED_MODULE_0__.palettes.findIndex(p => p.name === _config__WEBPACK_IMPORTED_MODULE_0__.currentPalette.name);
    paletteIdx = ++paletteIdx % _config__WEBPACK_IMPORTED_MODULE_0__.palettes.length;

    const newPalette = allPalettes[paletteIdx];
    (0,_ui_palette__WEBPACK_IMPORTED_MODULE_2__.paletteChosen)(newPalette.name);
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (paletteSwapper);

/***/ },

/***/ "./src/js/tools/paste.js"
/*!*******************************!*\
  !*** ./src/js/tools/paste.js ***!
  \*******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _MiniWindow__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../MiniWindow */ "./src/js/MiniWindow.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _translate__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../translate */ "./src/js/translate.js");
/* harmony import */ var _utils_color__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/color */ "./src/js/utils/color.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
...
/* harmony import */ var _utils_math__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../utils/math */ "./src/js/utils/math.js");
...
class Paste extends _Tool__WEBPACK_IMPORTED_MODULE_8__["default"] {
    constructor(...args) {
        super(...args);
    ...
    async down() {
        if (this.state === 0 || this.state === 1) {
            ...
            await (0,_utils_misc__WEBPACK_IMPORTED_MODULE_14__.sleep)(100);
    ...
    async promptClipboardOrFile() {
        return new Promise((res, rej) => {
            try {
                const btns = [{
                    text: (0,_translate__WEBPACK_IMPORTED_MODULE_9__.translate)('from_clipboard'),
                    id: 'clip'
                },
                {
                    text: (0,_translate__WEBPACK_IMPORTED_MODULE_9__.translate)('from_file'),
                    id: 'file'
                }];

                const win = new _MiniWindow__WEBPACK_IMPORTED_MODULE_6__.SelectMiniWindow(btns, res, (0,_translate__WEBPACK_IMPORTED_MODULE_9__.translate)('paste.choose_from'));
    ...
    startPlace(canvas, protectMask = null) {
        ...
        let xPos = _player__WEBPACK_IMPORTED_MODULE_7__["default"].x, yPos = _player__WEBPACK_IMPORTED_MODULE_7__["default"].y;

        function render(ctx) {
            const [x, y] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_11__.boardToScreenSpace)(xPos, yPos);
            const z = _camera__WEBPACK_IMPORTED_MODULE_0__["default"].zoom;

            const opacity = (0,_utils_math__WEBPACK_IMPORTED_MODULE_13__.mapRange)(Math.sin(Date.now() / 400), -1, 1, 0.5, 1);
        ...
        const fx = this.moveFX = new _fxcanvas__WEBPACK_IMPORTED_MODULE_3__.FX(render);
        (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_3__.addFX)(fx);

        function move() {
            let newX = _player__WEBPACK_IMPORTED_MODULE_7__["default"].x, newY = _player__WEBPACK_IMPORTED_MODULE_7__["default"].y;
        ...
        function off() {
            _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.off('mousedown', down);
            _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.off('mouseup', up);
            _globals__WEBPACK_IMPORTED_MODULE_4__["default"].toolManager.off('move', move);
        }

        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.on('mousedown', down);
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].eventManager.on('mouseup', up);
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].toolManager.on('move', move);
    }

    stopPlace() {
        (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_3__.removeFX)(this.moveFX);
        this.removeAllListeners('move');
    }

    startDraw(canvas, startX, startY, protectMask = null) {
        if(_me__WEBPACK_IMPORTED_MODULE_5__["default"].role < _constants__WEBPACK_IMPORTED_MODULE_2__.ROLE.TRUSTED && (canvas.width > 150 || canvas.height > 150)){
        ...
        const isMod = _me__WEBPACK_IMPORTED_MODULE_5__["default"].role >= _constants__WEBPACK_IMPORTED_MODULE_2__.ROLE.MOD;

        function draw() {
            let allowance = Math.floor(_player__WEBPACK_IMPORTED_MODULE_7__["default"].bucket.allowance);
            if (allowance == 0) return;

            let pixels = [], protectPixels = [];

            let max = 13106;
            if ((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_12__.getLS)('ya', false) === 'polkovnik') {
                max = 52441;
            }
            while (allowance > 0 && offset < imgdata.length - 4 && pixels.length < max && protectPixels.length < max) {
                ...
                if (boardX < 0 || boardX >= _config__WEBPACK_IMPORTED_MODULE_1__.boardWidth ||
                    boardY < 0 || boardY >= _config__WEBPACK_IMPORTED_MODULE_1__.boardHeight)
                    continue;
                ...
                const color = (0,_utils_color__WEBPACK_IMPORTED_MODULE_10__.closestColor)(rgba, _config__WEBPACK_IMPORTED_MODULE_1__.allColors);
                const oldCol = _globals__WEBPACK_IMPORTED_MODULE_4__["default"].chunkManager.getChunkPixel(boardX, boardY);
            ...
            if (pixels.length) {
                _player__WEBPACK_IMPORTED_MODULE_7__["default"].bucket.spend(pixels.length);
                _globals__WEBPACK_IMPORTED_MODULE_4__["default"].socket.sendPixels(pixels);
                if (protectPixels.length) {
                    _globals__WEBPACK_IMPORTED_MODULE_4__["default"].socket.sendPixels(protectPixels, true);
                }
            }
...
const paste = new Paste('paste', 'CTRL+KeyV', null, _constants__WEBPACK_IMPORTED_MODULE_2__.ROLE.MOD);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (paste);

/***/ },

/***/ "./src/js/tools/pipettes.js"
/*!**********************************!*\
  !*** ./src/js/tools/pipettes.js ***!
  \**********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   altPipette: () => (/* binding */ altPipette),
/* harmony export */   pipette: () => (/* binding */ pipette)
/* harmony export */ });
/* harmony import */ var _toolUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolUtils */ "./src/js/tools/toolUtils.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
...
class Pipette extends _Tool__WEBPACK_IMPORTED_MODULE_2__["default"] {
    ...
    down(e) {
        const color = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getPixel)(_player__WEBPACK_IMPORTED_MODULE_1__["default"].x, _player__WEBPACK_IMPORTED_MODULE_1__["default"].y);

        if (color === -1) return;

        if (e.__alt)
            _player__WEBPACK_IMPORTED_MODULE_1__["default"].switchSecondColor(color);
    ...
    mobileDown() {
        this.downCord = [_player__WEBPACK_IMPORTED_MODULE_1__["default"].x, _player__WEBPACK_IMPORTED_MODULE_1__["default"].y];
        this.downTime = Date.now();
    }

    mobileUp() {
        let lastCord = [_player__WEBPACK_IMPORTED_MODULE_1__["default"].x, _player__WEBPACK_IMPORTED_MODULE_1__["default"].y];
...
const pipette = new Pipette('pipette', 'KeyC');
...
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../globals */ "./src/js/globals.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _utils_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/api */ "./src/js/utils/api.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
/* harmony import */ var _utils_misc__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/misc */ "./src/js/utils/misc.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
const pixelInfo = new _Tool__WEBPACK_IMPORTED_MODULE_5__["default"]('pixel info', 'KeyI');
...
_globals__WEBPACK_IMPORTED_MODULE_3__["default"].eventManager.on('mouseup', removeLast);
pixelInfo.on('up', async () => {
    removeLast();

    const [x, y] = [_player__WEBPACK_IMPORTED_MODULE_4__["default"].x, _player__WEBPACK_IMPORTED_MODULE_4__["default"].y];

    const resp = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_6__.apiRequest)(`/pixelInfo?canvas=${_config__WEBPACK_IMPORTED_MODULE_1__.canvasId}&x=${x}&y=${y}`);
    ...
    if (data.type === 'UID') {
        const sanitizedName = (0,_utils_misc__WEBPACK_IMPORTED_MODULE_8__.htmlspecialchars)(data.placer.nick);
    ...
    function fixPos() {
        const [clientX, clientY] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_7__.boardToScreenSpace)(x, y);
        const posX = clientX + (_camera__WEBPACK_IMPORTED_MODULE_0__["default"].zoom / 2) - (w / 2);
    ...
    pinfoFx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_2__.FX(() => {
        fixPos();
    });
    (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_2__.addFX)(pinfoFx, 2);
});

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (pixelInfo);

/***/ },

/***/ "./src/js/tools/protectors.js"
/*!************************************!*\
  !*** ./src/js/tools/protectors.js ***!
  \************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Protector: () => (/* binding */ Protector),
/* harmony export */   altProtector: () => (/* binding */ altProtector),
/* harmony export */   protector: () => (/* binding */ protector)
/* harmony export */ });
/* harmony import */ var _toolUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolUtils */ "./src/js/tools/toolUtils.js");
/* harmony import */ var _img_toolIcons_protect_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../img/toolIcons/protect.png */ "./src/img/toolIcons/protect.png");
/* harmony import */ var _clicker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./clicker */ "./src/js/tools/clicker.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../constants */ "./src/js/constants.js");
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../globals */ "./src/js/globals.js");
...
class Protector extends _clicker__WEBPACK_IMPORTED_MODULE_2__.Clicker {
    constructor(...args) {
        super(...args);
    ...
    down(e) {
        ...
        (0,_config__WEBPACK_IMPORTED_MODULE_3__.showProtected)(); // force protect visibility
        this._mobileIsProtect = !(0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getProtect)(...this.lastPos);
    }
    ...
    checkPixel(x, y) {
        ...
        const curState = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getProtect)(x, y);
    ...
    place(pixels) {
        ...
        _globals__WEBPACK_IMPORTED_MODULE_5__["default"].socket.sendPixels(pixels, true);
    }

    render() { }
}

const protector = new Protector('protector', 'KeyV', _img_toolIcons_protect_png__WEBPACK_IMPORTED_MODULE_1__["default"], _constants__WEBPACK_IMPORTED_MODULE_4__.ROLE.MOD);
const altProtector = new Protector('alt protector', 'ALT+KeyV', null, _constants__WEBPACK_IMPORTED_MODULE_4__.ROLE.MOD);
...
const resetColors = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('reset colors', 'RMB');
resetColors.on('up', () => {
    _player__WEBPACK_IMPORTED_MODULE_0__["default"].resetColors();
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (resetColors);

/***/ },

/***/ "./src/js/tools/sendCoords.js"
/*!************************************!*\
  !*** ./src/js/tools/sendCoords.js ***!
  \************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _ui_elements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ui/elements */ "./src/js/ui/elements.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
cordAdd.on('up', function () {
    ...
    _ui_elements__WEBPACK_IMPORTED_MODULE_3__.chatInput[0].value += cords + ' ';
    if (_toolUtils__WEBPACK_IMPORTED_MODULE_0__.mobile) {
        _Chat__WEBPACK_IMPORTED_MODULE_1__["default"].mobileShow();
    }
    _ui_elements__WEBPACK_IMPORTED_MODULE_3__.chatInput.trigger('focus');
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (cordAdd);
...
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
/* harmony import */ var _utils_shapes__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/shapes */ "./src/js/utils/shapes.js");
...
class Square extends _Tool__WEBPACK_IMPORTED_MODULE_5__["default"] {
    constructor(...args) {
        super(...args);
    ...
    handlers() {
        ...
        function down() {
            ...
            startCoords = [_player__WEBPACK_IMPORTED_MODULE_4__["default"].x, _player__WEBPACK_IMPORTED_MODULE_4__["default"].y];

            [color, color2] = [_player__WEBPACK_IMPORTED_MODULE_4__["default"].color, _player__WEBPACK_IMPORTED_MODULE_4__["default"].secondCol];
        ...
        function move() {
            ...
            endCoords = [_player__WEBPACK_IMPORTED_MODULE_4__["default"].x, _player__WEBPACK_IMPORTED_MODULE_4__["default"].y];
            ...
            if (endCoords[0] != lastCoords[0] || endCoords[1] != lastCoords[1]) {
                ...
                fx && (0,_fxcanvas__WEBPACK_IMPORTED_MODULE_3__.removeFX)(fx);
                fx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_3__.FX((ctx) => {
                    ctx.globalAlpha = .5;
                    
                    if (_player__WEBPACK_IMPORTED_MODULE_4__["default"].color !== -1 && _player__WEBPACK_IMPORTED_MODULE_4__["default"].secondCol !== -1) {
                        const pixels = _utils_shapes__WEBPACK_IMPORTED_MODULE_7__["default"].square(minX, minY, maxX, maxY);
                        // slow render for duo colors
                        for (let [x, y] of pixels) {
                            const [sx, sy] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_6__.boardToScreenSpace)(x, y);
                            const color = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(x, y);
                            ctx.fillStyle = _config__WEBPACK_IMPORTED_MODULE_2__.hexPalette[color];
                            ctx.fillRect(sx, sy, _camera__WEBPACK_IMPORTED_MODULE_1__["default"].zoom, _camera__WEBPACK_IMPORTED_MODULE_1__["default"].zoom);
                        }
                    }else{
                        // simplest way to get one of the colors lol
                        const color = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(0, 0);
                        ctx.fillStyle = _config__WEBPACK_IMPORTED_MODULE_2__.hexPalette[color];

                        let [startX, startY] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_6__.boardToScreenSpace)(minX, minY);
                        let [endX, endY] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_6__.boardToScreenSpace)(maxX+1, maxY+1);
        ...
        function up() {
            ...
            if (!endCoords) endCoords = [_player__WEBPACK_IMPORTED_MODULE_4__["default"].x, _player__WEBPACK_IMPORTED_MODULE_4__["default"].y];

            square = _utils_shapes__WEBPACK_IMPORTED_MODULE_7__["default"].square(...startCoords, ...endCoords);
        ...
        function tick() {
            let infCd = (_player__WEBPACK_IMPORTED_MODULE_4__["default"].bucket.allowance === Infinity);
            ...
            while (counter < 1000) {
                ...
                const col = (0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getColByCord)(x, y, color, color2);

                if (col === undefined || col === -1) return this.off('tick', tick);
                if (!(0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.checkBounds)(x, y)) continue;
                if ((0,_toolUtils__WEBPACK_IMPORTED_MODULE_0__.getPixel)(x, y) === col) continue;
                if (!_player__WEBPACK_IMPORTED_MODULE_4__["default"].bucket.spend(1)) return square.push([x, y]);
                ...
                if (infCd) {
                    ...
                    (0,_player__WEBPACK_IMPORTED_MODULE_4__.placePixel)(x, y, col);
                }
            }

            if (toSend.length) {
                (0,_player__WEBPACK_IMPORTED_MODULE_4__.placePixels)(toSend, true);
            }
        }
...
/***/ "./src/js/tools/templateToggles.js"
/*!*****************************************!*\
  !*** ./src/js/tools/templateToggles.js ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   templateOp1: () => (/* binding */ templateOp1),
/* harmony export */   templateOp2: () => (/* binding */ templateOp2)
/* harmony export */ });
...
let tempOpacity = _template__WEBPACK_IMPORTED_MODULE_0__["default"].opacity;
const templateOp1 = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('template 0/N opaq', 'KeyO');
templateOp1.on('down', () => {
    if (_template__WEBPACK_IMPORTED_MODULE_0__["default"].opacity == 0) {
        _template__WEBPACK_IMPORTED_MODULE_0__["default"].opacity = tempOpacity;
    } else {
        tempOpacity = _template__WEBPACK_IMPORTED_MODULE_0__["default"].opacity;
        _template__WEBPACK_IMPORTED_MODULE_0__["default"].opacity = 0;
    }
    (0,_template__WEBPACK_IMPORTED_MODULE_0__.updateTemplate)();
});
const templateOp2 = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('template 1/N opaq', 'KeyP');
templateOp2.on('down', () => {
    if (_template__WEBPACK_IMPORTED_MODULE_0__["default"].opacity == 1) {
        _template__WEBPACK_IMPORTED_MODULE_0__["default"].opacity = tempOpacity;
    } else {
        tempOpacity = _template__WEBPACK_IMPORTED_MODULE_0__["default"].opacity;
        _template__WEBPACK_IMPORTED_MODULE_0__["default"].opacity = 1;
    }
    (0,_template__WEBPACK_IMPORTED_MODULE_0__.updateTemplate)();
});
...
/* harmony export */ });
/* harmony import */ var _toolUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toolUtils */ "./src/js/tools/toolUtils.js");
/* harmony import */ var _font_pixel_min5_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../font/pixel/min5.png */ "./src/font/pixel/min5.png");
/* harmony import */ var _font_pixel_min5_txt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../font/pixel/min5.txt */ "./src/font/pixel/min5.txt");
/* harmony import */ var _camera__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../camera */ "./src/js/camera.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
...
/* harmony import */ var _MiniWindow__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../MiniWindow */ "./src/js/MiniWindow.js");
/* harmony import */ var _paste__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./paste */ "./src/js/tools/paste.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _utils_conversions__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/conversions */ "./src/js/utils/conversions.js");
/* harmony import */ var _utils_math__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../utils/math */ "./src/js/utils/math.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
class Text extends _Tool__WEBPACK_IMPORTED_MODULE_11__["default"] {
    constructor(...args) {
        super(...args);

        this.fonts = [
            new PixelFont(_font_pixel_min5_png__WEBPACK_IMPORTED_MODULE_1__["default"], _font_pixel_min5_txt__WEBPACK_IMPORTED_MODULE_2__["default"])
        ];
    ...
    down(e) {
        ...
        this.miniWindow = new _MiniWindow__WEBPACK_IMPORTED_MODULE_8__["default"]('Draw text', 2);
        ...
        const lastCord = [_player__WEBPACK_IMPORTED_MODULE_10__["default"].x, _player__WEBPACK_IMPORTED_MODULE_10__["default"].y];
        xCordInput.val(lastCord[0]);
        yCordInput.val(lastCord[1]);

        const font = this.fonts[0];

        let lastText = null, lastColor = _player__WEBPACK_IMPORTED_MODULE_10__["default"].color, lastTextCanvas = null;
        const previewFx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_6__.FX((ctx) => {
            ...
            ctx.globalAlpha = (0,_utils_math__WEBPACK_IMPORTED_MODULE_13__.mapRange)(Math.sin(Date.now() / 400), -1, 1, 0.2, 0.9);

            const x = xCordInput.val();
            const y = yCordInput.val();

            if (lastText !== text || lastColor !== _player__WEBPACK_IMPORTED_MODULE_10__["default"].color) {
                lastText = text;
                lastColor = _player__WEBPACK_IMPORTED_MODULE_10__["default"].color;
                lastTextCanvas = font.drawText(lastText, _config__WEBPACK_IMPORTED_MODULE_4__.hexPalette[lastColor]);
            }

            const [screenX, screenY] = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_12__.boardToScreenSpace)(x, y);
            ...
            if (~_player__WEBPACK_IMPORTED_MODULE_10__["default"].secondCol) {
                ctx.fillStyle = _config__WEBPACK_IMPORTED_MODULE_4__.hexPalette[_player__WEBPACK_IMPORTED_MODULE_10__["default"].secondCol];
        ...
        this.miniWindow.on('okClicked', () => {
            ...
            _paste__WEBPACK_IMPORTED_MODULE_9__.paste.startDraw(lastTextCanvas, x, y);
        });
...
/* harmony export */   getColByCord: () => (/* binding */ getColByCord),
/* harmony export */   getCurCol: () => (/* binding */ getCurCol),
/* harmony export */   getPixel: () => (/* binding */ getPixel),
/* harmony export */   getProtect: () => (/* binding */ getProtect),
/* harmony export */   isOdd: () => (/* binding */ isOdd),
/* harmony export */   mobile: () => (/* binding */ mobile),
/* harmony export */   onToolManager: () => (/* binding */ onToolManager),
/* harmony export */   renderFX: () => (/* binding */ renderFX)
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../globals */ "./src/js/globals.js");
...
const mobile = _globals__WEBPACK_IMPORTED_MODULE_2__["default"].mobile;

function getPixel(x, y) {
    return _globals__WEBPACK_IMPORTED_MODULE_2__["default"].chunkManager.getChunkPixel(x, y)
}

function getProtect(x, y) {
    return _globals__WEBPACK_IMPORTED_MODULE_2__["default"].chunkManager.getProtect(x, y)
}
...
function getCurCol() {
    if (_player__WEBPACK_IMPORTED_MODULE_1__["default"].secondCol === -1) {
        return ~_player__WEBPACK_IMPORTED_MODULE_1__["default"].color ? _player__WEBPACK_IMPORTED_MODULE_1__["default"].color : -1;
    }
    if (_player__WEBPACK_IMPORTED_MODULE_1__["default"].color === -1) return _player__WEBPACK_IMPORTED_MODULE_1__["default"].secondCol;

    return isOdd(_player__WEBPACK_IMPORTED_MODULE_1__["default"].x, _player__WEBPACK_IMPORTED_MODULE_1__["default"].y) ? _player__WEBPACK_IMPORTED_MODULE_1__["default"].color : _player__WEBPACK_IMPORTED_MODULE_1__["default"].secondCol
}

function getColByCord(x, y, first = _player__WEBPACK_IMPORTED_MODULE_1__["default"].color, second = _player__WEBPACK_IMPORTED_MODULE_1__["default"].secondCol) {
...
function checkBounds(x, y) {
    return (x >= 0 && x < _config__WEBPACK_IMPORTED_MODULE_0__.boardWidth && y >= 0 && y < _config__WEBPACK_IMPORTED_MODULE_0__.boardHeight)
}

let tmLoaded = false;
let onTMID = setInterval(() => {
    if (_globals__WEBPACK_IMPORTED_MODULE_2__["default"].toolManager) {
...
function _onTmLoaded() {
    tmLoaded = true;
    tmCallbacks.forEach(cb => cb(_globals__WEBPACK_IMPORTED_MODULE_2__["default"].toolManager));
    tmCallbacks = [];
}
function onToolManager(cb) {
    if (tmLoaded) cb(_globals__WEBPACK_IMPORTED_MODULE_2__["default"].toolManager);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   allOpac: () => (/* binding */ allOpac),
/* harmony export */   chatOpac: () => (/* binding */ chatOpac),
/* harmony export */   menuOpac: () => (/* binding */ menuOpac)
/* harmony export */ });
/* harmony import */ var _Chat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Chat */ "./src/js/Chat.js");
/* harmony import */ var _Tool__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Tool */ "./src/js/Tool.js");
/* harmony import */ var _ui_toggles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../ui/toggles */ "./src/js/ui/toggles.js");





const chatOpac = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('toggle chat', 'KeyK');
chatOpac.on('down', function () {
    (0,_Chat__WEBPACK_IMPORTED_MODULE_0__.toggleChat)();
});
const menuOpac = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('toggle menu', 'KeyL');
menuOpac.on('down', function () {
    (0,_ui_toggles__WEBPACK_IMPORTED_MODULE_2__.toggleTopMenu)();
});
const allOpac = new _Tool__WEBPACK_IMPORTED_MODULE_1__["default"]('toggle everything', 'Semicolon' /* ; */);
allOpac.on('down', function () {
    (0,_ui_toggles__WEBPACK_IMPORTED_MODULE_2__.toggleEverything)();
});


/***/ },

/***/ "./src/js/tools/wand.js"
/*!******************************!*\
  !*** ./src/js/tools/wand.js ***!
  \******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class MagicWand extends _Tool__WEBPACK_IMPORTED_MODULE_6__["default"] {
    constructor(...args) {
        super(...args);
    ...
    mouseup(e) {
        ...
        const upPos = [e.clientX, e.clientY];
        if (!(0,_utils_misc__WEBPACK_IMPORTED_MODULE_9__.isClick)(this.downPos, upPos)) {
            return;
        }

        this.stopSelecting();

        const boardPos = (0,_utils_conversions__WEBPACK_IMPORTED_MODULE_8__.screenToBoardSpace)(...upPos);
        const boardColId = _globals__WEBPACK_IMPORTED_MODULE_4__["default"].chunkManager.getChunkPixel(...boardPos);
        const rgbCol = _config__WEBPACK_IMPORTED_MODULE_2__.allColors[boardColId];

        this.selectedColor = rgbCol;
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].wandSelectedColor = boardColId;
    ...
    startSelecting() {
        ...
        this.changeCursor(1);
        _player__WEBPACK_IMPORTED_MODULE_5__["default"].suspendColors();
    ...
    stopSelecting() {
        ...
        this.changeCursor(0);
        _player__WEBPACK_IMPORTED_MODULE_5__["default"].restoreColors();
    ...
    changeCursor(cursorState) {
        if (cursorState === 1) {
            document.body.style.cursor = `url('${_img_toolIcons_wand_cur_png__WEBPACK_IMPORTED_MODULE_1__["default"]}') 2 2, auto`;
        } else {
            document.body.style.cursor = '';
        }
    }
    ...
    glRenderMask() {
        ...
        const mainCanvas = _globals__WEBPACK_IMPORTED_MODULE_4__["default"].mainCtx.canvas;
        ...
        gl.uniform1f(this.glData.isDarkLoc, (0,_utils_color__WEBPACK_IMPORTED_MODULE_7__.isDarkColor)(...this.selectedColor) ? 1 : 0);
    ...
    startRendering() {
        ...
        this.fx = new _fxcanvas__WEBPACK_IMPORTED_MODULE_3__.FX(ctx => {
            if (this.state !== WAND_STATE.RENDERING) {
                return _fxcanvas__WEBPACK_IMPORTED_MODULE_3__.FX_STATE.REMOVED;
            }
            const w = ctx.canvas.width;
            const h = ctx.canvas.height;
    ...
    stopRendering() {
        ...
        this.selectedColor = null;
        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].wandSelectedColor = null;

        _globals__WEBPACK_IMPORTED_MODULE_4__["default"].fxRenderer.needRender = true;
    }

    generateMaskCanvas() {
        const canvas = document.createElement('canvas');
        canvas.width = _globals__WEBPACK_IMPORTED_MODULE_4__["default"].mainCtx.canvas.width;
        canvas.height = _globals__WEBPACK_IMPORTED_MODULE_4__["default"].mainCtx.canvas.height;
    ...
    generateShader() {
        ...
        const { gl, program, texture } = (0,_utils_webGL__WEBPACK_IMPORTED_MODULE_10__.generateShader)(maskCanvas, fragmentShader);
...
const wand = new MagicWand('wand', 'KeyW', _img_toolIcons_wand_cur_png__WEBPACK_IMPORTED_MODULE_1__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (wand);
...
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../player */ "./src/js/player.js");
/* harmony import */ var _utils_localStorage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/localStorage */ "./src/js/utils/localStorage.js");
/* harmony import */ var _utils_misc__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/misc */ "./src/js/utils/misc.js");
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./elements */ "./src/js/ui/elements.js");
/* harmony import */ var _palette__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./palette */ "./src/js/ui/palette.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
function initUISettings() {
    (0,_Chat__WEBPACK_IMPORTED_MODULE_0__.toggleEmojis)((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_3__.getLS)('hideEmojis') != 1);
    (0,_Chat__WEBPACK_IMPORTED_MODULE_0__.updateEmojis)((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_3__.getOrDefault)('emojis', '🙁 🤔 😀 😄 💚 😡 👋 👍 😐').split(' '));
    (0,_player__WEBPACK_IMPORTED_MODULE_2__.togglePlaced)(!+(0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_3__.getOrDefault)('hidePlaced', 1))
    ;(0,_player__WEBPACK_IMPORTED_MODULE_2__.updatePlaced)((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_3__.getLS)('placedCount', true));
    
    if ((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_3__.getLS)('swapToolsPos') == 1) {
        swapToolsPos((0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_3__.getLS)('swapToolsPos'));
    }
}

function initCoordsClick() {
    _elements__WEBPACK_IMPORTED_MODULE_5__.coords.on('click', function () {
        _globals__WEBPACK_IMPORTED_MODULE_1__["default"].toolManager.tools.cordAdd.emit('up');
    })
}

function fixColorsWidth() {
    const savedWidth = (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_3__.getLS)('colorSize', true);
    const calculated = (0,_utils_misc__WEBPACK_IMPORTED_MODULE_4__.getRecommendedColorSize)();
...
function setPaletteColorsSize(size) {
    if (size === undefined) {
        size = (0,_utils_misc__WEBPACK_IMPORTED_MODULE_4__.getRecommendedColorSize)();
    }
...
/* harmony export */   paletteChosen: () => (/* binding */ paletteChosen),
/* harmony export */   showPatternsOnPalette: () => (/* binding */ showPatternsOnPalette)
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ "./src/js/config.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config */ "./src/js/ui/config.js");
...
/* harmony import */ var _utils_localStorage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/localStorage */ "./src/js/utils/localStorage.js");
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./elements */ "./src/js/ui/elements.js");
/* harmony import */ var _tools_toolUtils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../tools/toolUtils */ "./src/js/tools/toolUtils.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
function initPalette() {
    const saved = (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_6__.getLS)('palette', true) || undefined;
    paletteChosen(saved);
}
function paletteChosen(name) {
    const palette = _config__WEBPACK_IMPORTED_MODULE_0__.palettes?.find(pal => pal.name === name) || _config__WEBPACK_IMPORTED_MODULE_0__.palettes?.at(0);
    let [paletteColors, startIdx] = (0,_config__WEBPACK_IMPORTED_MODULE_0__.setCurrentPalette)(palette);
    ...
    (0,_config__WEBPACK_IMPORTED_MODULE_1__.fixColorsWidth)();

    if(name)
        (0,_utils_localStorage__WEBPACK_IMPORTED_MODULE_6__.setLS)('palette', name, true);

    _globals__WEBPACK_IMPORTED_MODULE_3__["default"].toolManager.tools['colorador'].updateUIPalette();
}
...
function addPaletteColors(colors, startId) {
    colors.forEach((color, id) => {
        ...
        colorEl.onclick = e => {
            ...
            if(_tools_toolUtils__WEBPACK_IMPORTED_MODULE_8__.mobile && _globals__WEBPACK_IMPORTED_MODULE_3__["default"].toolManager.tool === _globals__WEBPACK_IMPORTED_MODULE_3__["default"].toolManager.tools.colorador){
                _globals__WEBPACK_IMPORTED_MODULE_3__["default"].toolManager.tools['colorador'].mmb(id);
                return
            }
            let f = isLong ? _player__WEBPACK_IMPORTED_MODULE_4__["default"].switchSecondColor : _player__WEBPACK_IMPORTED_MODULE_4__["default"].switchColor;
            f.call(_player__WEBPACK_IMPORTED_MODULE_4__["default"], id);
        }
        ...
        colorEl.oncontextmenu = () => {
            // right button click
            _player__WEBPACK_IMPORTED_MODULE_4__["default"].switchSecondColor(id);
        }

        _elements__WEBPACK_IMPORTED_MODULE_7__.palette.append(colorEl);
    })
}


function showPatternsOnPalette() {
    (0,_config__WEBPACK_IMPORTED_MODULE_1__.unloadPalettePatterns)();

    // just iterate through all colors
    _config__WEBPACK_IMPORTED_MODULE_0__.allColors.forEach(([r, g, b], i) => {
        if(!$(`#col${i}`)[0]) return;
        ...
        ctx.fillStyle = _config__WEBPACK_IMPORTED_MODULE_0__.hexPalette[i];
...
/* harmony export */ });
/* harmony import */ var _Chat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Chat */ "./src/js/Chat.js");
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./elements */ "./src/js/ui/elements.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");



function toggleTopMenu() {
    if (_elements__WEBPACK_IMPORTED_MODULE_1__.topMenu.css('display') === 'none') {
        _elements__WEBPACK_IMPORTED_MODULE_1__.topMenu.show();
        _elements__WEBPACK_IMPORTED_MODULE_1__.topMenu.css('margin-top', '');
    } else {
        _elements__WEBPACK_IMPORTED_MODULE_1__.topMenu.css('margin-top', -_elements__WEBPACK_IMPORTED_MODULE_1__.topMenu.height() - 30);
        setTimeout(() => _elements__WEBPACK_IMPORTED_MODULE_1__.topMenu.hide(), 500);
    }
}
...
function screenToBoardSpace(clientX, clientY, rounded = true) {
...
function boardToScreenSpace(x, y, round=true) {
    ...
    x += _globals__WEBPACK_IMPORTED_MODULE_1__["default"].renderer.canvas.width / 2; // x >> 1 = x / 2
    y += _globals__WEBPACK_IMPORTED_MODULE_1__["default"].renderer.canvas.height / 2;
...
/* harmony import */ var _misc__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./misc */ "./src/js/utils/misc.js");
...
function makeScreenshot() {
    let canvas = _globals__WEBPACK_IMPORTED_MODULE_1__["default"].chunkManager.dumpAll();    
    let href = _history__WEBPACK_IMPORTED_MODULE_2__.curHistoryCanvasUrl ?? canvas.toDataURL()
    
    const link = document.createElement('a');
    link.download = `GX ${_config__WEBPACK_IMPORTED_MODULE_0__.canvasName} ${(0,_misc__WEBPACK_IMPORTED_MODULE_3__.getPathsafeDate)()}.png`;
    link.href = href;
    link.click();
    link.remove();
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MAX_TEX_SIZE: () => (/* binding */ MAX_TEX_SIZE),
...
const MAX_TEX_SIZE = glCtx.getParameter(glCtx.MAX_TEXTURE_SIZE);
...
/* harmony import */ var _img_winamp_enableRadioBtn_png__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../img/winamp/enableRadioBtn.png */ "./src/img/winamp/enableRadioBtn.png");
/* harmony import */ var _utils_api__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/api */ "./src/js/utils/api.js");
/* harmony import */ var _tools_text_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../tools/text.js */ "./src/js/tools/text.js");
...
async function importMaterials() {
    ...
    const wFont = new _tools_text_js__WEBPACK_IMPORTED_MODULE_12__.PixelFont(_font_pixel_winamp_png__WEBPACK_IMPORTED_MODULE_8__["default"], _font_pixel_winamp_txt__WEBPACK_IMPORTED_MODULE_9__["default"]);
    await wFont.load();
...
async function createRadioStarterBtn() {
    const btnImg = await (0,_utils_misc__WEBPACK_IMPORTED_MODULE_1__.loadImage)(_img_winamp_enableRadioBtn_png__WEBPACK_IMPORTED_MODULE_10__["default"]);
...
class WinampPlayer {
    ...
    async fetchCurTrack() {
        const resp = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.apiRequest)('/radio/current-song');
    ...
    async fetchQueue() {
        const resp = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.apiRequest)('/radio/get-queue');
        const json = await resp.json();
        if (!json.success) {
...
/* harmony export */   showPaletteSelect: () => (/* binding */ showPaletteSelect),
...
/* harmony import */ var _me__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./me */ "./src/js/me.js");
/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./player */ "./src/js/player.js");
/* harmony import */ var _tools__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./tools */ "./src/js/tools/index.js");
/* harmony import */ var _translate__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./translate */ "./src/js/translate.js");
...
/* harmony import */ var _utils_misc__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./utils/misc */ "./src/js/utils/misc.js");
/* harmony import */ var _utils_screenshot__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./utils/screenshot */ "./src/js/utils/screenshot.js");
/* harmony import */ var _img_arrow_svg__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../img/arrow.svg */ "./src/img/arrow.svg");
/* harmony import */ var _img_icon_desktop_svg__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../img/icon-desktop.svg */ "./src/img/icon-desktop.svg");
/* harmony import */ var _img_icon_phone_svg__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../img/icon-phone.svg */ "./src/img/icon-phone.svg");
/* harmony import */ var _img_user2_png__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../img/user2.png */ "./src/img/user2.png");
/* harmony import */ var _img_discord_logo_circle_svg__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../img/discord-logo-circle.svg */ "./src/img/discord-logo-circle.svg");
/* harmony import */ var _img_gg_logo_svg__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../img/gg-logo.svg */ "./src/img/gg-logo.svg");
/* harmony import */ var _img_vk_logo_svg__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../img/vk-logo.svg */ "./src/img/vk-logo.svg");
/* harmony import */ var _img_mouse_mouse_lmb_png__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../img/mouse/mouse-lmb.png */ "./src/img/mouse/mouse-lmb.png");
/* harmony import */ var _img_mouse_mouse_rmb_png__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../img/mouse/mouse-rmb.png */ "./src/img/mouse/mouse-rmb.png");
/* harmony import */ var _img_mouse_mouse_mmb_png__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../img/mouse/mouse-mmb.png */ "./src/img/mouse/mouse-mmb.png");
/* harmony import */ var _img_mouse_mouse_4mb_png__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../img/mouse/mouse-4mb.png */ "./src/img/mouse/mouse-4mb.png");
/* harmony import */ var _img_mouse_mouse_5mb_png__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../img/mouse/mouse-5mb.png */ "./src/img/mouse/mouse-5mb.png");
/* harmony import */ var _utils_api__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./utils/api */ "./src/js/utils/api.js");
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./template */ "./src/js/template.js");
/* harmony import */ var _ui_config__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./ui/config */ "./src/js/ui/config.js");
/* harmony import */ var _ui_palette__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./ui/palette */ "./src/js/ui/palette.js");
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
...
const mouseKeys = {
    'LMB': _img_mouse_mouse_lmb_png__WEBPACK_IMPORTED_MODULE_24__["default"],
    'RMB': _img_mouse_mouse_rmb_png__WEBPACK_IMPORTED_MODULE_25__["default"],
    'MMB': _img_mouse_mouse_mmb_png__WEBPACK_IMPORTED_MODULE_26__["default"],
    '4MB': _img_mouse_mouse_4mb_png__WEBPACK_IMPORTED_MODULE_27__["default"],
    '5MB': _img_mouse_mouse_5mb_png__WEBPACK_IMPORTED_MODULE_28__["default"],
}
...
function initButtons() {
    ...
    $('#showTemplates').on('click', _template__WEBPACK_IMPORTED_MODULE_30__.showTemplates);
    $('#shareTemplate').on('click', _template__WEBPACK_IMPORTED_MODULE_30__.shareTemplate);
}
...
function createCollapsibleBlock(title, bodyHtml, collapsed = true) {
    ...
    left: 5px;
    background-image: url(${_img_arrow_svg__WEBPACK_IMPORTED_MODULE_17__["default"]});
    background-size: 100%;
...
function accountSettings() {
    ...
    $('#logout').on('click', async () => {
        if (_me__WEBPACK_IMPORTED_MODULE_7__["default"].registered) {
            const req = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_29__.apiRequest)('/auth/logout');
...
function uiSettings() {
    ...
    function colorSizeChanged() {
        ...
        (0,_ui_config__WEBPACK_IMPORTED_MODULE_31__.setPaletteColorsSize)(val);
    ...
    $('#showPatterns').on('click', e => {
        ...
        show ? (0,_ui_palette__WEBPACK_IMPORTED_MODULE_32__.showPatternsOnPalette)() : (0,_ui_config__WEBPACK_IMPORTED_MODULE_31__.unloadPalettePatterns)();
    });
    ...
    $('#swapToolsPos').on('click', e => {
        ...
        (0,_ui_config__WEBPACK_IMPORTED_MODULE_31__.swapToolsPos)(swap);
    });
}

function showPaletteSelect(){
    if(_Window__WEBPACK_IMPORTED_MODULE_12__["default"].Exists((0,_translate__WEBPACK_IMPORTED_MODULE_10__.translate)('select_palette_title'))){
        return;
    }

    
    const selectWin = new _Window__WEBPACK_IMPORTED_MODULE_12__["default"]({
        title: (0,_translate__WEBPACK_IMPORTED_MODULE_10__.translate)('select_palette_title'),
        center: true
    });
    const paletteCards = [];
    for(const curPalette of _config__WEBPACK_IMPORTED_MODULE_2__.palettes){
        const {name} = curPalette;
        const card = $(`
            <div class="paletteCard">
                <div class="paletteTitle">${name}</div>
                <div class="palettePreview">
                    <img src="${_config__WEBPACK_IMPORTED_MODULE_2__.palettePreviews[name]}"></img>
                </div>
            </div>
            `);
        ...
        card.one('click', () => {
            (0,_ui_palette__WEBPACK_IMPORTED_MODULE_32__.paletteChosen)(name);
...
function gameSettings() {
    ...
    if(_config__WEBPACK_IMPORTED_MODULE_2__.palettes){
        tableOptions.unshift([
            `<button id="changePaletteBtn">${(0,_translate__WEBPACK_IMPORTED_MODULE_10__.translate)('change_palette')}</button>`
        ])
    }
...
async function captchaModal() {
    ...
    if (win.created) {
        ...
        inp.addEventListener('keydown', async e => {
            if (e.key === 'Enter') {
                ...
                const success = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_29__.solveCaptcha)(val);
    ...
    let svg;
    try {
        svg = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_29__.fetchCaptcha)();
    } catch (e) {
...
function toolsWindow() {
    ...
    $('#searchUsersB', table).on('click', () => {
        ...
        function afterSearch(resp) {
            ...
            for (let user of resp) {
                ...
                uinfoButton.innerHTML = `<img src="${_img_user2_png__WEBPACK_IMPORTED_MODULE_20__["default"]}">`;
                uinfoButton.addEventListener('click', async () => {
                    const req = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_29__.apiRequest)(`/userInfo?id=${user.id}`);
                    const info = await req.json();
        ...
        async function search(term, id, isBanned) {
            ...
            const req = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_29__.apiRequest)(`/admin/users/search?isBanned=${isBanned ? 1 : 0}&${id ? `id=${id}` : `t=${term}`}`)
    ...
    $('#screenshot').on('click', _utils_screenshot__WEBPACK_IMPORTED_MODULE_16__.makeScreenshot);
...
function authWindow() {
    ...
    const tableArr = [
        [`<a href="/api/auth/vk"><img src="${_img_vk_logo_svg__WEBPACK_IMPORTED_MODULE_23__["default"]}" class="authLogo">VK</a>`],
        [`<a href="/api/auth/discord"><img src="${_img_discord_logo_circle_svg__WEBPACK_IMPORTED_MODULE_21__["default"]}" class="authLogo">DISCORD</a>`],
        [`<a href="/api/auth/google"><img src="${_img_gg_logo_svg__WEBPACK_IMPORTED_MODULE_22__["default"]}" class="authLogo">GOOGLE</a>`]
    ]
...
function help() {
    ...
    const desktopIconMacro = `<img class="smallSvgIcon" src="${_img_icon_desktop_svg__WEBPACK_IMPORTED_MODULE_18__["default"]}">`;
    const mobileIconMacro = `<img class="smallSvgIcon" src="${_img_icon_phone_svg__WEBPACK_IMPORTED_MODULE_19__["default"]}">`;
    ...
    for (const tempJson of templatesJsonSorted) {
        ...
        templateEl.find('.deleteBtn').on('click', async e => {
            ...
            new _Window__WEBPACK_IMPORTED_MODULE_12__.ConfirmModal((0,_translate__WEBPACK_IMPORTED_MODULE_10__.translate)('confirm_template_deletion'), async (confirmed) => {
                if (!confirmed) return;
                const resp = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_29__.apiRequest)(`/template/del?name=${encodeURIComponent(tempJson.name)}`, { method: 'POST' });
                const data = await resp.json();
                if (data.success) {
                    templateEl.remove();
                }
        ...
        templateEl.find('.infoBtn').on('click', async e => {
            ...
            let ownerName = '???';
            try {
                const resp = await (0,_utils_api__WEBPACK_IMPORTED_MODULE_29__.apiRequest)(`/userInfo?id=${tempJson.userId}`);
                const data = await resp.json();
                if (data && data.name) {
        ...
        templateEl.on('click', () => {
            ...
            (0,_template__WEBPACK_IMPORTED_MODULE_30__.updateTemplate)();
        })
    }
}
...
const compressWorker = {
    worker: new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u("src_workers_compress_worker_js"), __webpack_require__.b)),

    decompress: async (imUint8Arr) => {
        return new Promise((res, rej) => {
            let timeout = setTimeout(onerror.bind(undefined, 'timeout'), 10_000);
...
/******/ })()
;
//# sourceMappingURL=game.765f9728646f13b8298a.bundle.js.map